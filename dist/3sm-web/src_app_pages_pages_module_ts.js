(self["webpackChunk_3sm_web"] = self["webpackChunk_3sm_web"] || []).push([["src_app_pages_pages_module_ts"],{

/***/ 79561:
/*!**************************************************************!*\
  !*** ./src/app/pages/directives/has-permission.directive.ts ***!
  \**************************************************************/
...
/* harmony import */ var _service_permission_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../service/permission.service */ 69227);
...
class HasPermissionDirective {
  ...
  updateView() {
    ...
    // If separate inputs are provided
      ...
      hasAccess = this.permissionService.canAccessField(this.appHasPermissionResource, this.appHasPermissionField || '', this.appHasPermissionAction);
    }
  ...
  static {
    this.ɵdir = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({
      ...
      inputs: {
        ...
        appHasPermissionField: "appHasPermissionField"
      }
    });
  }
}
...
/***/ 19694:
/*!************************************************************!*\
  !*** ./src/app/pages/directives/move-to-body.directive.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MoveToBodyDirective: () => (/* binding */ MoveToBodyDirective)
/* harmony export */ });
...
class MoveToBodyDirective {
  ...
  static {
    this.ɵfac = function MoveToBodyDirective_Factory(t) {
      return new (t || MoveToBodyDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef));
    };
  }
  static {
    this.ɵdir = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      type: MoveToBodyDirective,
      selectors: [["", "appMoveToBody", ""]]
    });
  }
}
...
/***/ 80061:
/*!********************************************!*\
  !*** ./src/app/pages/gaurds/role.guard.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class RoleGuard {
  constructor(permissionService, authService, router) {
    this.permissionService = permissionService;
  ...
  canActivate(route, state) {
    ...
    if (requiredPermission) {
      ...
      const hasPermission = this.permissionService.hasPermission(requiredPermission.resource, requiredPermission.action);
      if (!hasPermission) {
  ...
  static {
    this.ɵfac = function RoleGuard_Factory(t) {
      return new (t || RoleGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_service_permission_service__WEBPACK_IMPORTED_MODULE_0__.PermissionService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_service_auth_service__WEBPACK_IMPORTED_MODULE_1__.AuthService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router));
    };
  }
  static {
...
/***/ 24335:
/*!********************************************************!*\
  !*** ./src/app/pages/highchart/highchart.component.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HighchartComponent: () => (/* binding */ HighchartComponent)
/* harmony export */ });
...
/* harmony import */ var _service_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/auth.service */ 9822);
/* harmony import */ var _service_permission_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/permission.service */ 69227);
...
class HighchartComponent {
  constructor(http, authService, permissionService) {
    this.http = http;
    this.authService = authService;
    this.permissionService = permissionService;
  ...
  fetchChartData() {
    ...
    this.http.get(`${this.apiUrl}/account/list`).subscribe(data => {
      const raw = data || [];
      const filtered = accountId != null ? raw.filter(item => {
  ...
  static {
    this.ɵfac = function HighchartComponent_Factory(t) {
      return new (t || HighchartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_service_auth_service__WEBPACK_IMPORTED_MODULE_2__.AuthService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_service_permission_service__WEBPACK_IMPORTED_MODULE_3__.PermissionService));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
      type: HighchartComponent,
      selectors: [["app-highchart"]],
      decls: 1,
      vars: 2,
      consts: [[2, "width", "100%", "height", "400px", "display", "block", 3, "Highcharts", "options"]],
      template: function HighchartComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelement"](0, "highcharts-chart", 0);
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("Highcharts", ctx.Highcharts)("options", ctx.chartOptions);
        }
      },
      dependencies: [highcharts_angular__WEBPACK_IMPORTED_MODULE_6__.HighchartsChartComponent],
...
/* harmony import */ var _gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gaurds/role.guard */ 80061);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
...
const routes = [{
  ...
  children: [{
    ...
    path: 'dashboard',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_dashboard_dashboard_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dashboard/dashboard.module */ 83326)).then(m => m.DashboardModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard]
    // Dashboard accessible without specific permission check (handled in guard)
  }, {
    path: 'account',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_account_account_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./account/account.module */ 88422)).then(m => m.AccountModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'account',
    ...
    path: 'instance',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("src_app_pages_instance_instance_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./instance/instance.module */ 80350)).then(m => m.InstanceModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'instance',
    ...
    path: 'user',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_user_user_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./user/user.module */ 40958)).then(m => m.UserModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'user',
    ...
    path: 'userrole',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_userrole_userrole_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./userrole/userrole.module */ 11350)).then(m => m.UserroleModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'userrole',
    ...
    path: 'city',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("src_app_pages_city_city_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./city/city.module */ 79878)).then(m => m.CityModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'city',
    ...
    path: 'gst',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_gst_gst_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./gst/gst.module */ 90318)).then(m => m.GstModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'gst',
    ...
    path: 'vat',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_vat_vat_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./vat/vat.module */ 71910)).then(m => m.VatModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'vat',
    ...
    path: 'product',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_product_product_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./product/product.module */ 32390)).then(m => m.ProductModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'product',
    ...
    path: 'digicard',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("src_app_pages_digicard_digicard_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./digicard/digicard.module */ 16494)).then(m => m.DigicardModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'digicard',
    ...
    path: 'sales',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_sales_sales_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./sales/sales.module */ 29694)).then(m => m.SalesModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'sales',
    ...
    path: 'salesedit',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_salesedit_salesedit_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./salesedit/salesedit.module */ 37686)).then(m => m.SaleseditModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'sales',
    ...
    path: 'customer',
    loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_devextreme_esm_excel_exporter_js-node_modules_exceljs_dist_exceljs_min_j-0fd609"), __webpack_require__.e("src_app_pages_customer_customer_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./customer/customer.module */ 84068)).then(m => m.CustomerModule),
    canActivate: [_gaurds_role_guard__WEBPACK_IMPORTED_MODULE_1__.RoleGuard],
    data: {
      permission: {
        resource: 'customer',
...
/* harmony import */ var _service_auth_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./service/auth.service */ 9822);
/* harmony import */ var _service_user_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service/user.service */ 48039);
/* harmony import */ var _service_permission_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./service/permission.service */ 69227);
...
/* harmony import */ var _angular_material_list__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/material/list */ 20943);
...
/* harmony import */ var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/sidenav */ 17049);
...
function PagesComponent_span_4_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](ctx_r14.userName);
  }
}
function PagesComponent_span_4_span_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](ctx_r15.userEmail);
  }
}
function PagesComponent_span_4_span_6_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span", 30);
...
function PagesComponent_span_4_span_7_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span", 32)(1, "mat-icon", 33);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "badge");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](ctx_r17.userRole);
  }
}
function PagesComponent_span_4_span_8_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span", 34);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](1, " (Role loading...) ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_span_4_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span", 23)(1, "mat-icon", 24);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](4, PagesComponent_span_4_span_4_Template, 2, 1, "span", 26);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](5, PagesComponent_span_4_span_5_Template, 2, 1, "span", 27);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](6, PagesComponent_span_4_span_6_Template, 2, 0, "span", 26);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](7, PagesComponent_span_4_span_7_Template, 5, 1, "span", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](8, PagesComponent_span_4_span_8_Template, 2, 0, "span", 29);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()();
  }
  if (rf & 2) {
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx_r0.userName && ctx_r0.userName.trim() !== "");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx_r0.userEmail && ctx_r0.userEmail.trim() !== "");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", !ctx_r0.userName && !ctx_r0.userEmail);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx_r0.userRole && ctx_r0.userRole.trim() !== "");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", !ctx_r0.userRole || ctx_r0.userRole.trim() === "");
  }
}
function PagesComponent_button_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "button", 35);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function PagesComponent_button_15_Template_button_click_0_listener() {
      ...
      return _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵresetView"](ctx_r19.authService.logout());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](1, "mat-icon", 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "logout_24");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()();
  }
}
function PagesComponent_a_23_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 36)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "perm_identity");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Account ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_24_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 37)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "business");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Instance ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_25_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 38)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "person_add");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "User ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_26_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 39)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "settings_applications");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "User Role ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_27_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 40)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "local_activity");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Digicard ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_28_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 41)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "fastfood");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Product ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_29_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 42)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "point_of_sale");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Sales ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_30_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 43)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "contacts");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Customer ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_31_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 44)(1, "mat-icon", 9);
...
function PagesComponent_a_32_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 45)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "money");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Gst ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_33_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 46)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "money");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Vat ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
function PagesComponent_a_34_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "a", 47)(1, "mat-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "High Chart");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Highcharts ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
  }
}
class PagesComponent {
  constructor(authService, userService, permissionService, cdr) {
    this.authService = authService;
  ...
  getUserRoleFallback() {
    ...
    if (user) {
      const roleName = user.roleName || user.rolename || user.role_name || user.userrolename || user.userRoleName || '';
  ...
  getLoggedInUser() {
    ...
    if (this.loggedInUser) {
      ...
      this.userName = this.loggedInUser.name || this.loggedInUser.username || this.loggedInUser.userName || this.loggedInUser.fullName || this.loggedInUser.firstName || (this.loggedInUser.firstName && this.loggedInUser.lastName ? `${this.loggedInUser.firstName} ${this.loggedInUser.lastName}` : '') || '';
      // Get email if not already set
      if (!this.userEmail) {
        this.userEmail = this.loggedInUser.email || this.loggedInUser.userEmail || this.loggedInUser.useremail || '';
      }
    } else {
  ...
  fetchUserDetailsFromAPI() {
    ...
    this.userService.getUserDetails().subscribe({
      next: users => {
        // Find user by email
        const user = users.find(u => u.useremail && u.useremail.toLowerCase() === email.toLowerCase() || u.email && u.email.toLowerCase() === email.toLowerCase());
        if (user) {
          // Extract user name from API response - try multiple property name variations
          this.userName = user.username || user.name || user.fullName || user.fullname || user.userName || user.user_name || (user.firstname && user.lastname ? `${user.firstname} ${user.lastname}` : '') || (user.firstName && user.lastName ? `${user.firstName} ${user.lastName}` : '') || user.firstname || user.firstName || user.lastname || user.lastName || '';
          ...
          const roleId = user.userroleid || user.userRoleId || user.user_role_id || user.roleId || user.roleid || user.role_id || user.userroleId || user.userRoleID;
          // Try to get role name from user object - check multiple field name variations
          const roleName = user.userrole || user.userRole || user.roleName || user.rolename || user.role_name || user.userrolename || user.userRoleName || user.user_role_name;
          if (roleId) {
  ...
  fetchRoleNameFromRoleId(roleId) {
    if (!roleId) {
      return;
    }
    ...
    this.permissionService.getRoleDetails(roleId).subscribe({
      next: roleDetails => {
        if (roleDetails) {
          const roleName = roleDetails.userrolename || roleDetails.roleName || roleDetails.rolename || roleDetails.name || roleDetails.userRoleName;
          if (roleName && roleName.trim() !== '') {
            this.userRole = roleName;
  ...
  updatePermissionServiceRoleName(roleName) {
    if (!roleName || roleName.trim() === '') {
      return;
    }
  ...
  getUserDisplayName() {
    ...
    if (this.loggedInUser) {
      ...
      for (const key in this.loggedInUser) {
        if (typeof this.loggedInUser[key] === 'string' && this.loggedInUser[key].trim() !== '' && key !== 'iat' && key !== 'exp' && key !== 'sub') {
  ...
  static {
    this.ɵfac = function PagesComponent_Factory(t) {
      return new (t || PagesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_auth_service__WEBPACK_IMPORTED_MODULE_0__.AuthService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_user_service__WEBPACK_IMPORTED_MODULE_1__.UserService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_permission_service__WEBPACK_IMPORTED_MODULE_2__.PermissionService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.ChangeDetectorRef));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      decls: 37,
      vars: 14,
      consts: [[1, "example-spacer"], ["style", "display: flex; align-items: center; margin-right: 15px; color: white;", 4, "ngIf"], ["mat-icon-button", ""], ["aria-label", "Example", 1, "example-icon"], ["href", "https://wa.me/919042041321", "target", "_blank"], ["mat-icon-button", "", 3, "click", 4, "ngIf"], ["mode", "side", "opened", ""], [2, "width", "2ovh"], ["mat-list-item", "", "routerLink", "dashboard", "href", "#", 1, "aligned-list-item"], [1, "aligned-icon"], ["mat-list-item", "", "routerLink", "account", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "instance", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "user", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "userrole", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "digicard", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "product", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "sales", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "customer", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "city", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "gst", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "vat", "href", "#", "class", "aligned-list-item", 4, "ngIf"], ["mat-list-item", "", "routerLink", "highchart", "href", "#", "class", "aligned-list-item", 4, "ngIf"], [1, "container-body"], [2, "display", "flex", "align-items", "center", "margin-right", "15px", "color", "white"], [2, "margin-right", "8px", "font-size", "20px", "width", "20px", "height", "20px"], [2, "display", "flex", "flex-direction", "column", "line-height", "1.2"], ["style", "font-size: 14px; font-weight: 500;", 4, "ngIf"], ["style", "font-size: 12px; opacity: 0.9;", 4, "ngIf"], ["style", "font-size: 11px; opacity: 0.9; margin-top: 2px; color: #ffd700; font-weight: 500; display: flex; align-items: center;", 4, "ngIf"], ["style", "font-size: 10px; opacity: 0.6; margin-top: 2px; color: #ccc; font-style: italic;", 4, "ngIf"], [2, "font-size", "14px", "font-weight", "500"], [2, "font-size", "12px", "opacity", "0.9"], [2, "font-size", "11px", "opacity", "0.9", "margin-top", "2px", "color", "#ffd700", "font-weight", "500", "display", "flex", "align-items", "center"], [2, "font-size", "14px", "width", "14px", "height", "14px", "margin-right", "4px"], [2, "font-size", "10px", "opacity", "0.6", "margin-top", "2px", "color", "#ccc", "font-style", "italic"], ["mat-icon-button", "", 3, "click"], ["mat-list-item", "", "routerLink", "account", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "instance", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "user", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "userrole", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "digicard", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "product", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "sales", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "customer", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "city", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "gst", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "vat", "href", "#", 1, "aligned-list-item"], ["mat-list-item", "", "routerLink", "highchart", "href", "#", 1, "aligned-list-item"]],
      template: function PagesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](2, "Connectsite");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelement"](3, "span", 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](4, PagesComponent_span_4_Template, 9, 5, "span", 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](5, "button", 2)(6, "mat-icon", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](7, "share");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](8, "button", 2)(9, "mat-icon", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](10, "shopping_cart_checkout_24");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](11, "a", 4)(12, "button", 2)(13, "mat-icon", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](14, "forum_24\"");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()()();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](15, PagesComponent_button_15_Template, 3, 0, "button", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](16, "mat-sidenav-container")(17, "mat-sidenav", 6)(18, "mat-nav-list", 7)(19, "a", 8)(20, "mat-icon", 9);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](21, "dashboard");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](22, "Dashboard");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](23, PagesComponent_a_23_Template, 4, 0, "a", 10);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](24, PagesComponent_a_24_Template, 4, 0, "a", 11);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](25, PagesComponent_a_25_Template, 4, 0, "a", 12);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](26, PagesComponent_a_26_Template, 4, 0, "a", 13);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](27, PagesComponent_a_27_Template, 4, 0, "a", 14);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](28, PagesComponent_a_28_Template, 4, 0, "a", 15);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](29, PagesComponent_a_29_Template, 4, 0, "a", 16);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](30, PagesComponent_a_30_Template, 4, 0, "a", 17);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](31, PagesComponent_a_31_Template, 4, 0, "a", 18);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](32, PagesComponent_a_32_Template, 4, 0, "a", 19);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](33, PagesComponent_a_33_Template, 4, 0, "a", 20);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](34, PagesComponent_a_34_Template, 4, 0, "a", 21);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()();
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("account"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("instance"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("user"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.canManageRbac());
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("digicard"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("product"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("sales"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("customer"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("city"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("gst"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("vat"));
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.permissionService.hasAnyPermissionForResource("dashboard") || ctx.permissionService.hasAnyPermissionForResource("highchart"));
        }
      },
      dependencies: [_angular_router__WEBPACK_IMPORTED_MODULE_4__.RouterOutlet, _angular_router__WEBPACK_IMPORTED_MODULE_4__.RouterLink, _angular_material_button__WEBPACK_IMPORTED_MODULE_5__.MatIconButton, _angular_material_list__WEBPACK_IMPORTED_MODULE_6__.MatNavList, _angular_material_list__WEBPACK_IMPORTED_MODULE_6__.MatListItem, _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_7__.MatToolbar, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_8__.MatSidenav, _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_8__.MatSidenavContainer, _angular_material_icon__WEBPACK_IMPORTED_MODULE_9__.MatIcon, _angular_common__WEBPACK_IMPORTED_MODULE_10__.NgIf],
      styles: ["/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsInNvdXJjZVJvb3QiOiIifQ== */"]
    });
  }
}
...
/* harmony import */ var _pages_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages.component */ 45816);
/* harmony import */ var _service_form_material_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./service/form-material.module */ 55751);
/* harmony import */ var highcharts_angular__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! highcharts-angular */ 31769);
/* harmony import */ var _highchart_highchart_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./highchart/highchart.component */ 24335);
...
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/shared.module */ 22866);
...
class PagesModule {
  ...
  static {
    this.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
      type: PagesModule,
      bootstrap: [_pages_component__WEBPACK_IMPORTED_MODULE_2__.PagesComponent]
    });
  }
  static {
    this.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
      providers: [_service_instance_service__WEBPACK_IMPORTED_MODULE_1__.InstanceService],
      imports: [_pages_routing_module__WEBPACK_IMPORTED_MODULE_0__.PagesRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_7__.HttpClientModule, _service_form_material_module__WEBPACK_IMPORTED_MODULE_3__.FormMaterialModule, highcharts_angular__WEBPACK_IMPORTED_MODULE_8__.HighchartsChartModule, _angular_common__WEBPACK_IMPORTED_MODULE_9__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormsModule, devextreme_angular__WEBPACK_IMPORTED_MODULE_11__.DxDataGridModule, devextreme_angular__WEBPACK_IMPORTED_MODULE_12__.DxButtonModule, devextreme_angular__WEBPACK_IMPORTED_MODULE_13__.DxChartModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.ReactiveFormsModule, _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__.SharedModule]
    });
  }
}
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](PagesModule, {
    declarations: [_pages_component__WEBPACK_IMPORTED_MODULE_2__.PagesComponent, _highchart_highchart_component__WEBPACK_IMPORTED_MODULE_4__.HighchartComponent],
    imports: [_pages_routing_module__WEBPACK_IMPORTED_MODULE_0__.PagesRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_7__.HttpClientModule, _service_form_material_module__WEBPACK_IMPORTED_MODULE_3__.FormMaterialModule, highcharts_angular__WEBPACK_IMPORTED_MODULE_8__.HighchartsChartModule, _angular_common__WEBPACK_IMPORTED_MODULE_9__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormsModule, devextreme_angular__WEBPACK_IMPORTED_MODULE_11__.DxDataGridModule, devextreme_angular__WEBPACK_IMPORTED_MODULE_12__.DxButtonModule, devextreme_angular__WEBPACK_IMPORTED_MODULE_13__.DxChartModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.ReactiveFormsModule, _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__.SharedModule]
  });
})();
...
class CustomerService {
  ...
  getCustomerCounts() {
    return this.http.get(`${this.apiUrl}/customer/counts`);
  }
...
/***/ 55751:
/*!*******************************************************!*\
  !*** ./src/app/pages/service/form-material.module.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/datepicker */ 61977);
...
/***/ 48039:
/*!***********************************************!*\
  !*** ./src/app/pages/service/user.service.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 80837:
/*!*******************************************************************************!*\
  !*** ./src/app/pages/shared/add-customer-form/add-customer-form.component.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AddCustomerFormComponent: () => (/* binding */ AddCustomerFormComponent)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
...
/* harmony import */ var _service_customer_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../service/customer.service */ 41068);
/* harmony import */ var _service_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../service/auth.service */ 9822);
...
function AddCustomerFormComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function AddCustomerFormComponent_mat_error_7_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, "Customer name is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
}
function AddCustomerFormComponent_mat_error_8_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, "Customer name must be at least 3 characters");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
}
function AddCustomerFormComponent_mat_error_13_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
...
function AddCustomerFormComponent_mat_error_14_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, "Please enter a valid mobile number (10-12 digits)");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
}
function AddCustomerFormComponent_mat_error_19_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
...
function AddCustomerFormComponent_select_27_option_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("value", city_r11.cityname);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](city_r11.cityname);
  }
}
function AddCustomerFormComponent_select_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "select", 24);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("change", function AddCustomerFormComponent_select_27_Template_select_change_0_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r13);
      const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵresetView"](ctx_r12.onCityChange($event));
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](1, "option", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](2, "Select");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](3, AddCustomerFormComponent_select_27_option_3_Template, 2, 2, "option", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
    const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx_r6.cityDropdown);
  }
}
function AddCustomerFormComponent_input_28_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "input", 27);
  }
}
function AddCustomerFormComponent_mat_error_29_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
...
function AddCustomerFormComponent_mat_error_52_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, "Active status is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
}
class AddCustomerFormComponent {
  constructor(fb, customerService, authService) {
    this.fb = fb;
  ...
  buildForm() {
    ...
    return this.fb.group({
      customerid: [0],
      customername: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.minLength(3), _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.maxLength(100)]],
      customermobile: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.pattern(/^[0-9]{10,12}$/)]],
      customeremail: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.email]],
      customeraddress: [''],
      customercity: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required],
      customerstate: [''],
      customercountry: [''],
      customerpincode: [''],
      accountid: [accountId],
  ...
  loadCities() {
    this.customerService.getCityDropdown().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)([]))).subscribe(items => {
  ...
  static {
    this.ɵfac = function AddCustomerFormComponent_Factory(t) {
      return new (t || AddCustomerFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormBuilder), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_service_customer_service__WEBPACK_IMPORTED_MODULE_0__.CustomerService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_service_auth_service__WEBPACK_IMPORTED_MODULE_1__.AuthService));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      type: AddCustomerFormComponent,
      selectors: [["app-add-customer-form"]],
      outputs: {
        saved: "saved",
        cancelled: "cancelled"
      },
      decls: 58,
      vars: 13,
      consts: [[1, "add-customer-form-container"], ["class", "error-message", "style", "background-color: #f8d7da; color: #721c24; padding: 12px; border-radius: 4px; margin-bottom: 15px; border: 1px solid #f5c6cb;", 4, "ngIf"], [3, "formGroup", "ngSubmit"], ["appearance", "outline", 1, "form-field"], [2, "color", "black"], ["matInput", "", "placeholder", "Customer Name", "formControlName", "customername", 1, "mat-input-element", "custom-placeholder"], [4, "ngIf"], ["maxlength", "12", "matInput", "", "placeholder", "1234-567890", "formControlName", "customermobile", "type", "tel", 1, "mat-input-element", "custom-placeholder"], [2, "color", "black !important"], ["matInput", "", "placeholder", "Email", "formControlName", "customeremail", "type", "email", 1, "mat-input-element", "custom-placeholder"], ["matInput", "", "placeholder", "Address", "formControlName", "customeraddress", 1, "mat-input-element", "custom-placeholder"], ["matNativeControl", "", "formControlName", "customercity", 3, "change", 4, "ngIf"], ["matInput", "", "placeholder", "Enter city", "class", "mat-input-element custom-placeholder", "formControlName", "customercity", 4, "ngIf"], ["matInput", "", "placeholder", "State", "formControlName", "customerstate", 1, "mat-input-element", "custom-placeholder"], ["matInput", "", "placeholder", "Country", "formControlName", "customercountry", 1, "mat-input-element", "custom-placeholder"], ["matInput", "", "placeholder", "Pincode", "formControlName", "customerpincode", 1, "mat-input-element", "custom-placeholder"], ["matNativeControl", "", "formControlName", "isactive"], ["value", "", "disabled", ""], ["value", "true"], ["value", "false"], [1, "form-submit"], ["mat-raised-button", "", "type", "button", 3, "click"], ["mat-raised-button", "", "type", "submit", 1, "btn-primary", 3, "disabled"], [1, "error-message", 2, "background-color", "#f8d7da", "color", "#721c24", "padding", "12px", "border-radius", "4px", "margin-bottom", "15px", "border", "1px solid #f5c6cb"], ["matNativeControl", "", "formControlName", "customercity", 3, "change"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["matInput", "", "placeholder", "Enter city", "formControlName", "customercity", 1, "mat-input-element", "custom-placeholder"]],
      template: function AddCustomerFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, AddCustomerFormComponent_div_1_Template, 2, 1, "div", 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](2, "form", 2);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngSubmit", function AddCustomerFormComponent_Template_form_ngSubmit_2_listener() {
            return ctx.submit();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](3, "mat-form-field", 3)(4, "mat-label", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](5, "Customer Name");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](6, "input", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](7, AddCustomerFormComponent_mat_error_7_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](8, AddCustomerFormComponent_mat_error_8_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](9, "mat-form-field", 3)(10, "mat-label", 4);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](13, AddCustomerFormComponent_mat_error_13_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](14, AddCustomerFormComponent_mat_error_14_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](15, "mat-form-field", 3)(16, "mat-label", 8);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](19, AddCustomerFormComponent_mat_error_19_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](20, "mat-form-field", 3)(21, "mat-label", 4);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](24, "mat-form-field", 3)(25, "mat-label", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](26, "City");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](27, AddCustomerFormComponent_select_27_Template, 4, 1, "select", 11);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](28, AddCustomerFormComponent_input_28_Template, 1, 0, "input", 12);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](29, AddCustomerFormComponent_mat_error_29_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](30, "mat-form-field", 3)(31, "mat-label", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](32, "State");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](33, "input", 13);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](34, "mat-form-field", 3)(35, "mat-label", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](36, "Country");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](37, "input", 14);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](38, "mat-form-field", 3)(39, "mat-label", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](40, "Pincode");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](41, "input", 15);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](42, "mat-form-field", 3)(43, "mat-label", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](44, "Active");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](45, "select", 16)(46, "option", 17);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](47, "Select");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](48, "option", 18);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](49, "Active");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](50, "option", 19);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](51, "Inactive");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](52, AddCustomerFormComponent_mat_error_52_Template, 2, 0, "mat-error", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](53, "div", 20)(54, "button", 21);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function AddCustomerFormComponent_Template_button_click_54_listener() {
            return ctx.close();
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_2_0 = ctx.form.get("customername")) == null ? null : tmp_2_0.hasError("required")) && ((tmp_2_0 = ctx.form.get("customername")) == null ? null : tmp_2_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_3_0 = ctx.form.get("customername")) == null ? null : tmp_3_0.hasError("minlength")) && ((tmp_3_0 = ctx.form.get("customername")) == null ? null : tmp_3_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_4_0 = ctx.form.get("customermobile")) == null ? null : tmp_4_0.hasError("required")) && ((tmp_4_0 = ctx.form.get("customermobile")) == null ? null : tmp_4_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_5_0 = ctx.form.get("customermobile")) == null ? null : tmp_5_0.hasError("pattern")) && ((tmp_5_0 = ctx.form.get("customermobile")) == null ? null : tmp_5_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_6_0 = ctx.form.get("customeremail")) == null ? null : tmp_6_0.hasError("email")) && ((tmp_6_0 = ctx.form.get("customeremail")) == null ? null : tmp_6_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.cityDropdown.length > 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.cityDropdown.length === 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_9_0 = ctx.form.get("customercity")) == null ? null : tmp_9_0.hasError("required")) && ((tmp_9_0 = ctx.form.get("customercity")) == null ? null : tmp_9_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](23);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_10_0 = ctx.form.get("isactive")) == null ? null : tmp_10_0.hasError("required")) && ((tmp_10_0 = ctx.form.get("isactive")) == null ? null : tmp_10_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("disabled", ctx.form.invalid || ctx.form.pending || ctx.isSaving);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", ctx.isSaving ? "Saving..." : "Submit", " ");
        }
      },
      dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_6__.NgIf, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgSelectOption, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ɵNgSelectMultipleOption"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.SelectControlValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.MaxLengthValidator, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormGroupDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControlName, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__.MatFormField, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__.MatLabel, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__.MatError, _angular_material_input__WEBPACK_IMPORTED_MODULE_8__.MatInput, _angular_material_button__WEBPACK_IMPORTED_MODULE_9__.MatButton],
      styles: [".add-customer-form-container[_ngcontent-%COMP%] {\n  max-width: 100%;\n  width: 100%;\n  box-sizing: border-box;\n}\n\n.add-customer-form-container[_ngcontent-%COMP%]   form[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 16px;\n}\n\n.add-customer-form-container[_ngcontent-%COMP%]   .form-field[_ngcontent-%COMP%] {\n  width: 100%;\n}\n\n.add-customer-form-container[_ngcontent-%COMP%]   .form-submit[_ngcontent-%COMP%] {\n  grid-column: 1 / -1;\n  display: flex;\n  justify-content: flex-end;\n  gap: 12px;\n  margin-top: 8px;\n}\n\n.add-customer-form-container[_ngcontent-%COMP%]   .form-submit[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  min-width: 100px;\n}\n\n.add-customer-form-container[_ngcontent-%COMP%]   .form-submit[_ngcontent-%COMP%]   .btn-primary[_ngcontent-%COMP%] {\n  background-color: #337ab7;\n  color: white;\n}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/***/ 4017:
/*!***********************************************************************!*\
  !*** ./src/app/pages/shared/customer-form/customer-form.component.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ 34456);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ 72354);
...
function CustomerFormComponent_p_1_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 24);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, "Add Customer");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
}
function CustomerFormComponent_button_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "button", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function CustomerFormComponent_button_2_Template_button_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r13);
      const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵresetView"](ctx_r12.onCancel());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, "\u00D7");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
}
function CustomerFormComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function CustomerFormComponent_mat_error_9_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Customer name is required ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function CustomerFormComponent_mat_error_10_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Customer name must be at least 3 characters ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function CustomerFormComponent_mat_error_15_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Mobile number is required ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function CustomerFormComponent_mat_error_16_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Please enter a valid mobile number (10-12 digits) ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function CustomerFormComponent_mat_error_21_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Enter a valid email ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function CustomerFormComponent_select_29_option_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("value", city_r15.cityname);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](city_r15.cityname);
  }
}
function CustomerFormComponent_select_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "select", 27);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("change", function CustomerFormComponent_select_29_Template_select_change_0_listener($event) {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r17);
      const ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵresetView"](ctx_r16.onCityChange($event));
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](1, "option", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](2, "Select");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](3, CustomerFormComponent_select_29_option_3_Template, 2, 2, "option", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
    const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx_r8.cityDropdown);
  }
}
function CustomerFormComponent_input_30_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "input", 30);
  }
}
function CustomerFormComponent_mat_error_31_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " City is required ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
function CustomerFormComponent_mat_error_54_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1, " Active status is required ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
class CustomerFormComponent {
  constructor(fb, customerService, authService) {
    ...
    this.customerSaved = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.EventEmitter();
  ...
  loadCities() {
    ...
    this.customerService.getCityDropdown().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.timeout)(4000), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.of)([]))).subscribe(items => {
      this.cityDropdown = Array.isArray(items) ? items : [];
  ...
  onSubmit() {
    if (this.customerForm.invalid) {
      Object.keys(this.customerForm.controls).forEach(k => this.customerForm.get(k)?.markAsTouched());
      this.errorMessage = 'Please fill all required fields correctly.';
      return;
    }
    this.isSaving = true;
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      decls: 58,
      vars: 15,
      consts: [[1, "form-container"], ["style", "font-size: larger;", 4, "ngIf"], ["class", "close-btn", 3, "click", 4, "ngIf"], ["class", "error-message", "style", "background-color: #f8d7da; color: #721c24; padding: 12px; border-radius: 4px; margin-bottom: 15px; border: 1px solid #f5c6cb;", 4, "ngIf"], [3, "formGroup", "ngSubmit"], ["appearance", "outline", 1, "form-field"], [2, "color", "black"], ["matInput", "", "placeholder", "Customer Name", "formControlName", "customername", 1, "mat-input-element", "custom-placeholder"], [4, "ngIf"], ["maxlength", "12", "matInput", "", "placeholder", "1234-567890", "formControlName", "customermobile", "type", "tel", 1, "mat-input-element", "custom-placeholder"], [2, "color", "black !important"], ["matInput", "", "placeholder", "Email", "formControlName", "customeremail", "type", "email", 1, "mat-input-element", "custom-placeholder"], ["matInput", "", "placeholder", "Address", "formControlName", "customeraddress", 1, "mat-input-element", "custom-placeholder"], ["matNativeControl", "", "formControlName", "customercity", 3, "change", 4, "ngIf"], ["matInput", "", "placeholder", "Enter city", "class", "mat-input-element custom-placeholder", "formControlName", "customercity", 4, "ngIf"], ["matInput", "", "placeholder", "State", "formControlName", "customerstate", 1, "mat-input-element", "custom-placeholder"], ["matInput", "", "placeholder", "Country", "formControlName", "customercountry", 1, "mat-input-element", "custom-placeholder"], ["matInput", "", "placeholder", "Pincode", "formControlName", "customerpincode", 1, "mat-input-element", "custom-placeholder"], ["matNativeControl", "", "formControlName", "isactive"], ["value", "", "disabled", ""], ["value", "true"], ["value", "false"], [1, "form-submit"], ["mat-raised-button", "", "type", "submit", 1, "btn-primary", 3, "disabled"], [2, "font-size", "larger"], [1, "close-btn", 3, "click"], [1, "error-message", 2, "background-color", "#f8d7da", "color", "#721c24", "padding", "12px", "border-radius", "4px", "margin-bottom", "15px", "border", "1px solid #f5c6cb"], ["matNativeControl", "", "formControlName", "customercity", 3, "change"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["matInput", "", "placeholder", "Enter city", "formControlName", "customercity", 1, "mat-input-element", "custom-placeholder"]],
      template: function CustomerFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, CustomerFormComponent_p_1_Template, 2, 0, "p", 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](2, CustomerFormComponent_button_2_Template, 2, 0, "button", 2);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](3, CustomerFormComponent_div_3_Template, 2, 1, "div", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](4, "form", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngSubmit", function CustomerFormComponent_Template_form_ngSubmit_4_listener() {
            return ctx.onSubmit();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](5, "mat-form-field", 5)(6, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](7, "Customer Name");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](8, "input", 7);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](9, CustomerFormComponent_mat_error_9_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](10, CustomerFormComponent_mat_error_10_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](11, "mat-form-field", 5)(12, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](13, "Mobile Number");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](14, "input", 9);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](15, CustomerFormComponent_mat_error_15_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](16, CustomerFormComponent_mat_error_16_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](17, "mat-form-field", 5)(18, "mat-label", 10);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](21, CustomerFormComponent_mat_error_21_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](22, "mat-form-field", 5)(23, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](24, "Address");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](25, "input", 12);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](26, "mat-form-field", 5)(27, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](28, "City");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](29, CustomerFormComponent_select_29_Template, 4, 1, "select", 13);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](30, CustomerFormComponent_input_30_Template, 1, 0, "input", 14);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](31, CustomerFormComponent_mat_error_31_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](32, "mat-form-field", 5)(33, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](34, "State");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](35, "input", 15);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](36, "mat-form-field", 5)(37, "mat-label", 6);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](40, "mat-form-field", 5)(41, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](42, "Pincode");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](43, "input", 17);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](44, "mat-form-field", 5)(45, "mat-label", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](46, "Active");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](47, "select", 18)(48, "option", 19);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](49, "Select");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](50, "option", 20);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](51, "Active");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](52, "option", 21);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](53, "Inactive");
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](54, CustomerFormComponent_mat_error_54_Template, 2, 0, "mat-error", 8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](55, "div", 22)(56, "button", 23);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](57);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]()()()();
        }
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_4_0 = ctx.customerForm.get("customername")) == null ? null : tmp_4_0.hasError("required")) && ((tmp_4_0 = ctx.customerForm.get("customername")) == null ? null : tmp_4_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_5_0 = ctx.customerForm.get("customername")) == null ? null : tmp_5_0.hasError("minlength")) && ((tmp_5_0 = ctx.customerForm.get("customername")) == null ? null : tmp_5_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_6_0 = ctx.customerForm.get("customermobile")) == null ? null : tmp_6_0.hasError("required")) && ((tmp_6_0 = ctx.customerForm.get("customermobile")) == null ? null : tmp_6_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_7_0 = ctx.customerForm.get("customermobile")) == null ? null : tmp_7_0.hasError("pattern")) && ((tmp_7_0 = ctx.customerForm.get("customermobile")) == null ? null : tmp_7_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](5);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_8_0 = ctx.customerForm.get("customeremail")) == null ? null : tmp_8_0.hasError("email")) && ((tmp_8_0 = ctx.customerForm.get("customeremail")) == null ? null : tmp_8_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](8);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.cityDropdown.length > 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.cityDropdown.length === 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_11_0 = ctx.customerForm.get("customercity")) == null ? null : tmp_11_0.hasError("required")) && ((tmp_11_0 = ctx.customerForm.get("customercity")) == null ? null : tmp_11_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](23);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ((tmp_12_0 = ctx.customerForm.get("isactive")) == null ? null : tmp_12_0.hasError("required")) && ((tmp_12_0 = ctx.customerForm.get("isactive")) == null ? null : tmp_12_0.touched));
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("disabled", ctx.customerForm.invalid || ctx.customerForm.pending || ctx.isSaving);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", ctx.isSaving ? "Saving..." : "Submit", " ");
        }
      },
      dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgSelectOption, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ɵNgSelectMultipleOption"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.SelectControlValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.MaxLengthValidator, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormGroupDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControlName, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__.MatFormField, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__.MatLabel, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__.MatError, _angular_material_input__WEBPACK_IMPORTED_MODULE_9__.MatInput, _angular_material_button__WEBPACK_IMPORTED_MODULE_10__.MatButton],
      styles: [".form-container[_ngcontent-%COMP%] {\n  max-width: 100%;\n  margin: 15px auto;\n  padding: 20px;\n  border-radius: 8px;\n  box-shadow: 0 4px 8px rgba(243, 243, 243, 0.1);\n  background-color: #ffff;\n  margin-top: 1% !important;\n  overflow-y: auto;\n}\n\n.form-field[_ngcontent-%COMP%] {\n  width: 100%;\n  display: block;\n  margin-bottom: 4px;\n}\n\n.form-submit[_ngcontent-%COMP%] {\n  margin-top: 50px;\n  text-align: center;\n}\n\n.close-btn[_ngcontent-%COMP%] {\n  background: transparent;\n  box-shadow: none;\n  border: none;\n  font-size: 30px;\n  color: black;\n  font-weight: 700;\n  position: absolute;\n  top: 16px;\n  right: 20px;\n  cursor: pointer;\n  line-height: 1;\n}\n\n.close-btn[_ngcontent-%COMP%]:hover {\n  color: #c0392b;\n}\n\n.btn-primary[_ngcontent-%COMP%] {\n  background-color: #337ab7;\n  color: white;\n}\n\n\n\n  app-customer-form {\n  --mdc-outlined-text-field-focus-outline-color: #f7f5f5 !important;\n  --mdc-outlined-text-field-outline-color: #f7f5f5 !important;\n}\n\n  app-customer-form .mat-form-field-appearance-outline .mat-form-field-outline,   app-customer-form .mat-form-field-appearance-outline .mat-form-field-outline-thick {\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline {\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline-thick {\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline {\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline-thick {\n  border-color: #f7f5f5 !important;\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline-start,   app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline-gap,   app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline-end {\n  border-color: #f7f5f5 !important;\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline-start,   app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline-gap,   app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline-end {\n  border-color: #f7f5f5 !important;\n  color: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline svg {\n  fill: #f7f5f5 !important;\n  stroke: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline svg {\n  fill: #f7f5f5 !important;\n  stroke: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline-thick svg {\n  fill: #f7f5f5 !important;\n  stroke: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline-thick svg {\n  fill: #f7f5f5 !important;\n  stroke: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline .mat-form-field-outline svg path {\n  fill: #f7f5f5 !important;\n  stroke: #f7f5f5 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline svg path {\n  fill: #f7f5f5 !important;\n  stroke: #f7f5f5 !important;\n}\n\n\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-form-field-invalid .mat-form-field-outline-thick {\n  color: #f44336 !important;\n  border-color: #f44336 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-form-field-invalid .mat-form-field-outline {\n  color: #f44336 !important;\n}\n\n  app-customer-form .form-container .mat-form-field-appearance-outline.mat-form-field-invalid .mat-form-field-outline svg,   app-customer-form .form-container .mat-form-field-appearance-outline.mat-form-field-invalid .mat-form-field-outline-thick svg {\n  fill: #f44336 !important;\n  stroke: #f44336 !important;\n}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony import */ var _directives_has_permission_directive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../directives/has-permission.directive */ 79561);
/* harmony import */ var _directives_move_to_body_directive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../directives/move-to-body.directive */ 19694);
/* harmony import */ var _customer_form_customer_form_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./customer-form/customer-form.component */ 4017);
/* harmony import */ var _add_customer_form_add_customer_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-customer-form/add-customer-form.component */ 80837);
/* harmony import */ var _service_form_material_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/form-material.module */ 55751);
...
class SharedModule {
  ...
  static {
    this.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.ReactiveFormsModule, _service_form_material_module__WEBPACK_IMPORTED_MODULE_4__.FormMaterialModule]
    });
  }
}
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](SharedModule, {
    declarations: [_directives_has_permission_directive__WEBPACK_IMPORTED_MODULE_0__.HasPermissionDirective, _directives_move_to_body_directive__WEBPACK_IMPORTED_MODULE_1__.MoveToBodyDirective, _customer_form_customer_form_component__WEBPACK_IMPORTED_MODULE_2__.CustomerFormComponent, _add_customer_form_add_customer_form_component__WEBPACK_IMPORTED_MODULE_3__.AddCustomerFormComponent],
    imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.ReactiveFormsModule, _service_form_material_module__WEBPACK_IMPORTED_MODULE_4__.FormMaterialModule],
    exports: [_directives_has_permission_directive__WEBPACK_IMPORTED_MODULE_0__.HasPermissionDirective, _directives_move_to_body_directive__WEBPACK_IMPORTED_MODULE_1__.MoveToBodyDirective, _customer_form_customer_form_component__WEBPACK_IMPORTED_MODULE_2__.CustomerFormComponent, _add_customer_form_add_customer_form_component__WEBPACK_IMPORTED_MODULE_3__.AddCustomerFormComponent
...
*/
function (t, e) {
   true ? (t._Highcharts = e(), module.exports = t._Highcharts) : 0;
  ...
  var i,
    ...
    v = {};
  v.d = (t, e) => {
    for (var i in e) v.o(e, i) && !v.o(t, i) && Object.defineProperty(t, i, {
      enumerable: !0,
      get: e[i]
    });
 ...
 - ${i}: ${e}`, r && (a += encodeURI(i) + "=" + encodeURI(e));
  ...
  function U(t, e, i, s) {
    if (i = i || {}, S?.createEvent && (t.dispatchEvent || t.fireEvent && t !== w)) {
      ...
      s.initEvent(e, !0, !0), i = R(s, i), t.dispatchEvent ? t.dispatchEvent(i) : t.fireEvent(e, i);
    } else if (t.hcEvents) {
      i.target || R(i, {
  ...
  T.jQuery && (T.jQuery.fn.highcharts = function () {
    ...
    if (this[0]) return t[0] ? (new w[P(t[0]) ? t.shift() : "Chart"](this[0], t[0], t[1]), this) : M[N(this[0], "data-highcharts-chart")];
  });
  let V = {
      ...
      getNestedProperty: function (t, e) {
        ...
        for (; i.length && B(e);) {
          ...
          let s = e[t.replace(/[\\'"]/g, "")];
          if (!B(s) || "function" == typeof s || "number" == typeof s.nodeType || s === T) return;
          e = s;
        }
        return e;
      },
      ...
      insertItem: function (t, e) {
        let i,
          s = t.options.index,
          o = e.length;
        for (i = t.options.isInternal ? o : 0; i < o + 1; i++) if (!e[i] || D(s) && s < W(e[i].options.index, e[i]._i) || e[i].options.isInternal) {
          e.splice(i, 0, t);
          break;
        }
        return i;
    ...
    td = class {
      constructor(t, e) {
        this.options = {
          timezone: "UTC"
        }, this.variableTimezone = !1, this.Date = _.Date, this.update(t), this.lang = e;
      }
      update(t = {}) {
      ...
      dateTimeFormat(t, e, i = this.options.locale || Z) {
        ...
        if (!o) {
          ...
          try {
            ...
            /Invalid time zone/i.test(e.message) ? (K(34), t.timeZone = "UTC", o = new Intl.DateTimeFormat(i, t)) : K(e.message, !1);
          }
        }
      ...
      dateFormat(t, e, i) {
        ...
        if (te(t) && -1 !== t.indexOf("%")) {
          ...
          ts(J({
            ...
            if (te(t)) for (; -1 !== t.indexOf("%" + o);) t = t.replace("%" + o, "function" == typeof s ? s.call(i, e) : s);
          });
        } else if (tt(t)) {
    ...
    tu = class extends td {
      getTimeTicks(t, e, i, s) {
        let o = this,
          ...
          m;
        if (s ?? (s = 1), tc(e)) {
          if (f = h >= tg.second ? 0 : n * Math.floor(f / n), h >= tg.second && (u = h >= tg.minute ? 0 : n * Math.floor(u / n)), h >= tg.minute && (g = h >= tg.hour ? 0 : n * Math.floor(g / n)), h >= tg.hour && (p = h >= tg.day ? 0 : n * Math.floor(p / n)), h >= tg.day && (c = h >= tg.month ? 1 : Math.max(1, n * Math.floor(c / n))), h >= tg.month && (d = h >= tg.year ? 0 : n * Math.floor(d / n)), h >= tg.year && (l -= l % n), h === tg.week) {
          ...
          e = o.makeTime(l, d, c, p, g, u, f), o.variableTimezone && tc(i) && (m = i - e > 4 * tg.month || o.getTimezoneOffset(e) !== o.getTimezoneOffset(i));
          let t = e,
            x = 1;
    ...
    tv = {
      ...
      setOptions: function (t) {
        return tm(w, "setOptions", {
          options: t
        }), tx(!0, ty, t), t.time && tb.update(ty.time), t.lang && "locale" in t.lang && tb.update({
  ...
  class tL {
    ...
    constructor(t) {
      ...
      if ("object" == typeof t && void 0 !== t.stops) this.stops = t.stops.map(t => new tL(t[1]));else if ("string" == typeof t) for (this.input = t = tL.names[t.toLowerCase()] || t, s = tL.parsers.length; s-- && !i;) (e = (o = tL.parsers[s]).regex.exec(t)) && (i = o.parse(e));
      i && (this.rgba = i);
    }
    get(t) {
      let e = this.input,
    ...
    tweenTo(t, e) {
      let i = this.rgba,
        s = t.rgba;
      if (!tw(i[0]) || !tw(s[0])) return tL.useColorMix && tP(this.input) && tP(t.input) && e < .99 ? tA(this.input, t.input, e) : t.input || "none";
      let o = 1 !== s[3] || 1 !== i[3],
        r = (t, s) => t + (i[s] - t) * (1 - e),
  ...
  class tB {
    ...
    run(t, e, i) {
      ...
      t !== e || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date(), this.start = t, this.end = e, this.unit = i, this.now = this.start, this.pos = 0, r.elem = this.elem, r.prop = this.prop, r() && 1 === tB.timers.push(r) && a(n)) : (delete o.curAnim[this.prop], o.complete && 0 === Object.keys(o.curAnim).length && o.complete.call(this.elem));
    }
    step(t) {
      let e,
        i,
        ...
        n = o.duration,
        h = o.curAnim;
      return r.attr && !r.element ? e = !1 : t || s >= n + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), h[this.prop] = !0, i = !0, tD(h, function (t) {
        !0 !== t && (i = !1);
    ...
    initPath(t, e, i) {
      ...
      return g.length && tI(l) && (d = r.length + l * n, p ? (u(g, r), f(r)) : (u(r, g), f(g))), [g, r];
    }
    fillSetter() {
  ...
  function tY(t, e) {
    ...
    for (; i--;) tB.timers[i].elem !== t || e && e !== tB.timers[i].prop || (tB.timers[i].stopped = !0);
  }
  let tU = {
      ...
      getDeferredAnimation: function (t, e, i) {
        ...
        return o.forEach(t => {
          ...
          r = tH(e) && tN(e.defer) ? s.defer : Math.max(r, i.duration + i.defer), a = Math.min(s.duration, i.duration);
  ...
  function ec(t, e, i, s) {
    ...
    let o,
      ...
      d = e,
      c = {};
    i ?? (i = h.decimalPoint), s ?? (s = h.thousandsSep), -1 === e ? e = Math.min(l, 20) : ei(e) ? e && n < 0 && ((r = e + n) >= 0 ? (a = +a.toExponential(r).split("e")[0], e = r) : (a = Math.floor(a), t = e < 20 ? +(a * Math.pow(10, n)).toFixed(e) : 0, n = 0)) : e = 2, n && (e ?? (e = 2), t = a), ei(e) && e >= 0 && (c.minimumFractionDigits = e, c.maximumFractionDigits = e), "" === s && (c.useGrouping = !1);
    let p = s || i,
      g = p ? "en" : this?.locale || h.locale || t8,
      u = JSON.stringify(c) + g;
    return o = (eh[u] ?? (eh[u] = new Intl.NumberFormat(g, c))).format(t), p && (o = o.replace(/([,\.])/g, "_$1").replace(/_\,/g, s ?? ",").replace("_.", i ?? ".")), (e || 0 != +o) && (!(n < 0) || d) || (o = "0"), n && 0 != +o && (o += "e" + (n < 0 ? "" : "+") + n), o;
  }
  let ep = {
  ...
  (o || (o = {})).distribute = function t(e, i, s) {
    ...
    if (x > r) {
      for (ex(e, (t, e) => (e.rank || 0) - (t.rank || 0)), g = (y = e[0].rank === e[e.length - 1].rank) ? h / 2 : -1, p = y ? g : h - 1; g && x > r;) f = e[c = Math.floor(p)], em(l, c) && (x -= f.size), p += g, y && p >= e.length && (g /= 2, p = g);
      l.sort((t, e) => e - t).forEach(t => d.apply(n, e.splice(t, 1)));
    }
    for (ex(e, a), e = e.map(t => ({
      size: t.size,
      targets: [t.target],
      align: ef(t.align, .5)
    })); u;) {
  ...
  class eK {
    ...
    animate(t, e, i) {
      let s = ev(eU(e, this.renderer.globalAnimation, !0)),
        o = s.defer;
      return eM.hidden && (s.duration = 0), 0 !== s.duration ? (i && (s.complete = i), e_(() => {
    ...
    attr(t, e, i, s) {
      ...
      return "string" == typeof t && void 0 !== e && (a = t, (t = {})[a] = e), "string" == typeof t ? h = (this[t + "Getter"] || this._defaultGetter).call(this, t, o) : (eY(t, function (e, i) {
        l = !1, s || ek(this, i), this.symbolName && -1 !== r.indexOf(i) && (n || (this.symbolAttr(t), n = !0), l = !0), this.rotation && ("x" === i || "y" === i) && (this.doTransform = !0), l || (this[i + "Setter"] || this._defaultSetter).call(this, e, i, o);
    ...
    crisp(t, e) {
      ...
      return eN(t, {
        ...
        width: eE(o, e) - a,
        height: eE(r, e) - n
      }), eD(t.strokeWidth) && (t.strokeWidth = e), t;
    }
    complexColor(t, e, i) {
      let s = this.renderer,
        o,
      ...
      ez(this.renderer, "complexColor", {
        ...
        if (t.radialGradient ? r = "radialGradient" : t.linearGradient && (r = "linearGradient"), r) {
          if (a = t[r], h = s.gradients, l = t.stops, p = i.radialReference, eW(a) && (t[r] = a = {
            x1: a[0],
            y1: a[1],
            x2: a[2],
            y2: a[3],
            gradientUnits: "userSpaceOnUse"
          }), "radialGradient" === r && p && !eD(a.gradientUnits) && (n = a, a = ej(a, s.getRadialAttr(p, n), {
            gradientUnits: "userSpaceOnUse"
          })), eY(a, function (t, e) {
            "id" !== e && u.push(e, t);
          }), eY(l, function (t) {
            u.push(t);
          }), h[u = u.join(",")]) g = h[u].attr("id");else {
            a.id = g = eq();
            let t = h[u] = s.createElement(r).attr(a).add(s.defs);
            t.radAttr = n, t.stops = [], l.forEach(function (e) {
              0 === e[1].indexOf("rgba") ? (d = (o = tL.parse(e[1])).get("rgb"), c = o.get("a")) : (d = e[1], c = 1);
    ...
    destroy() {
      let t = this,
        ...
        r,
        a;
      if (e.onclick = e.onmouseout = e.onmouseover = e.onmousemove = e.point = null, ek(t), t.clipPath && s) {
        let e = t.clipPath;
      ...
      for (t.safeRemoveChild(e); o?.div && 0 === o.div.childNodes.length;) r = o.parentGroup, t.safeRemoveChild(o.div), delete o.div, o = r;
      t.alignOptions && eB(i.alignedObjects, t), eY(t, (e, i) => {
        (t[i]?.parentGroup === t || -1 !== ["connector", "foreignObject"].indexOf(i)) && t[i]?.destroy?.(), delete t[i];
      });
    }
    dSetter(t, e, i) {
      eW(t) && ("string" == typeof t[0] && (t = this.renderer.pathToSegments(t)), this.pathArray = t, t = t.reduce((t, e, i) => e?.join ? (i ? t + " " : "") + e.join(" ") : (e || "").toString(), "")), /(NaN| {2}|^$)/.test(t) && (t = "M 0 0"), this[e] !== t && (i.setAttribute(e, t), this[e] = t);
    }
    fillSetter(t, e, i) {
    ...
    getBBox(t, e) {
      ...
      if (eD(d) && (-1 === (r = d.toString()).indexOf("<") && (r = r.replace(/\d/g, "0")), r += ["", h.rootFontSize, f, u, this.textWidth, a, l.lineClamp, l.textOverflow, l.fontWeight].join(",")), r && !t && (i = c[r]), !i || i.polygon) {
        if (g || h.forExport) {
          try {
            ...
            }, eH(o) && o("none"), i = n.getBBox ? eN({}, n.getBBox()) : {
              width: n.offsetWidth,
    ...
    constructor(t, e) {
      this.onEvents = {}, this.opacity = 1, this.SVG_NS = eT, this.element = "span" === e || "body" === e ? eO(e) : eM.createElementNS(this.SVG_NS, e), this.renderer = t, this.styles = {}, ez(this, "afterInit");
    }
    on(t, e) {
      let {
        onEvents: i
    ...
    titleSetter(t) {
      ...
      e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i), i.textContent = eZ(eU(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">");
    }
    toFront() {
      let t = this.element;
    ...
    updateTransform(t = "transform") {
      let {
        ...
        g = ["translate(" + c + "," + p + ")"];
      eD(s) && g.push("matrix(" + s.join(",") + ")"), r && (g.push("rotate(" + r + " " + (a ?? e.getAttribute("x") ?? this.x ?? 0) + " " + (n ?? e.getAttribute("y") ?? this.y ?? 0) + ")"), d?.element.tagName !== "SPAN" || d?.foreignObject || d.attr({
        rotation: r,
        rotationOriginX: (a || 0) - o,
        rotationOriginY: (n || 0) - o
      })), (eD(h) || eD(l)) && g.push("scale(" + eU(h, 1) + " " + eU(l, 1) + ")"), g.length && !(d || this).textPath && (i?.element || e).setAttribute(t, g.join(" "));
    }
    ...
    zIndexSetter(t, e) {
      let i = this.renderer,
        ...
        p = this.added,
        g;
      if (eD(t) ? (r.setAttribute("data-z-index", t), t *= 1, this[e] === t && (p = !1)) : eD(this[e]) && r.removeAttribute("data-z-index"), this[e] = t, p) {
        for ((t = this.zIndex) && s && (s.handleZ = !0), g = (n = o.childNodes).length - 1; g >= 0 && !d; g--) c = !eD(l = (h = n[g]).getAttribute("data-z-index")), h !== r && (t < 0 && c && !a && !g ? (o.insertBefore(r, n[g]), d = !0) : (e$(l) <= t || c && (!eD(t) || t >= 0)) && (o.insertBefore(r, n[g + 1]), d = !0));
  ...
  class e9 extends eJ {
    ...
    updateBoxSize() {
      ...
      if (this.baselineOffset = s + Math.min((this.text.firstLineMetrics || r).b, o.height || 1 / 0), this.heightSetting && (this.baselineOffset += (this.heightSetting - r.h) / 2), this.needsBox && !e.textPath) {
        ...
        i.x = t = this.getCrispAdjust(), i.y = (this.baseline ? -this.baselineOffset : 0) + t, i.width = Math.round(this.width), i.height = Math.round(this.height), this.box.attr(e0(i, this.deferredAttr)), this.deferredAttr = {};
      }
    }
    updateTextPadding() {
      let t = this.text,
  ...
  function it(t, e, i, s, o) {
    ...
    if (o) {
      ...
      b.params = {
        ...
        cx: t,
        cy: e
      }, r.push(["M", t + h * u, e + l * f], b), e4(p) && ((b = ["A", p, p, 0, y, e4(o.clockwise) ? 1 - o.clockwise : 0, t + p * u, e + p * f]).params = {
        start: n,
        end: a,
        cx: t,
        cy: e
      }, r.push(g ? ["M", t + p * m, e + p * x] : ["L", t + p * m, e + p * x], b)), g || r.push(["Z"]);
    }
    return r;
  }
  ...
  let is = {
      ...
      callout: function (t, e, i, s, o) {
        ...
        if (t + n > i - a) {
          if (h > e + a && h < e + s - a) l.splice(3, 1, ["L", t + i, h - 6], ["L", t + i + 6, h], ["L", t + i, h + 6], ["L", t + i, e + s - r]);else if (n < i) {
            let o = h < e + a,
              d = o ? e : e + s;
            l.splice(o ? 2 : 5, 0, ["L", n, h], ["L", t + i - r, d]);
          } else l.splice(3, 1, ["L", t + i, s / 2], ["L", n, h], ["L", t + i, s / 2], ["L", t + i, e + s - r]);
        } else if (t + n < a) {
          if (h > e + a && h < e + s - a) l.splice(7, 1, ["L", t, h + 6], ["L", t - 6, h], ["L", t, h - 6], ["L", t, e + r]);else if (n > 0) {
            let i = h < e + a,
              o = i ? e : e + s;
    ...
    im = class {
      ...
      modifyTree(t) {
        let e = (i, s) => {
          ...
          "#text" !== n && "a" !== n && (i.tagName = "tspan"), il(i, {
            attributes: o,
            style: a
      ...
      truncate(t, e, i, s, o, r, a) {
        ...
        if (l.rotation = 0, s + (h = f(t.textContent.length)) > o) {
          ...
          0 === g ? t.textContent = "" : e && g === e.length - 1 || (t.textContent = n || a(e || i, u)), this.ellipsis && h > o && this.truncate(t, t.textContent || "", void 0, 0, o, r, iu);
        }
  ...
  class iU {
    constructor(t, e, i, s, o, r, a) {
      ...
      a || l.css(this.getStyle(s || {})), t.appendChild(d), iL(t, "dir", "ltr"), -1 === t.innerHTML.indexOf("xmlns") && iL(d, "xmlns", this.SVG_NS), this.box = d, this.boxWrapper = l, this.alignedObjects = [], this.url = this.getReferenceURL(), this.createElement("desc").add().element.appendChild(iv.createTextNode("Created with Highcharts 12.4.0")), this.defs = this.createElement("defs").add(), this.allowHTML = r, this.forExport = o, this.styledMode = a, this.gradients = {}, this.cache = {}, this.cacheKeys = [], this.imgCount = 0, this.rootFontSize = l.getStyle("font-size"), this.setSize(e, i, !1), ik && t.getBoundingClientRect && ((n = function () {
        iI(t, {
          left: 0,
          top: 0
        }), h = t.getBoundingClientRect(), iI(t, {
    ...
    destroy() {
      let t = this.defs;
      return this.box = null, this.boxWrapper = this.boxWrapper.destroy(), iB(this.gradients || {}), this.gradients = null, this.defs = t.destroy(), this.unSubPixelFix && this.unSubPixelFix(), this.alignedObjects = null, null;
    }
    createElement(t) {
    ...
    button(t, e, i, s, o = {}, r, a, n, h, l) {
      ...
      return c || ["hover", "select", "disabled"].forEach((t, e) => {
        ...
        if (1 !== t && (d.state = g = t), d.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" + ["normal", "hover", "pressed", "disabled"][t]), !c) {
          d.attr(m[t]);
          let e = x[t];
          iW(e) && d.css(e);
        }
      }, d.attr(m[0]), !c && (d.css(iN({
        cursor: "default"
      }, f)), l && d.text.css({
        pointerEvents: "none"
    ...
    crispLine(t, e) {
      let [i, s] = t;
      return iD(i[1]) && i[1] === s[1] && (i[1] = s[1] = iE(i[1], e)), iD(i[2]) && i[2] === s[2] && (i[2] = s[2] = iE(i[2], e)), t;
    }
    path(t) {
    ...
    arc(t, e, i, s, o, r) {
      let a;
      iW(t) ? (e = (a = t).y, i = a.r, s = a.innerR, o = a.start, r = a.end, t = a.x) : a = {
        innerR: s,
        start: o,
        end: r
      };
    ...
    rect(t, e, i, s, o, r) {
      ...
      return this.styledMode || (void 0 !== r && (a["stroke-width"] = r, iN(a, n.crisp(a))), a.fill = "none"), n.rSetter = function (t, e, i) {
        n.r = t, iL(i, {
          rx: t,
          ry: t
        });
    ...
    symbol(t, e, i, s, o, r) {
      let a,
        ...
        u = g && this.symbols[g];
      if (u) "number" == typeof e && (n = u.call(this.symbols, e || 0, i || 0, s || 0, o || 0, r)), a = this.path(n), d.styledMode || a.attr("fill", "none"), iN(a, {
        symbolName: g || void 0,
        x: e,
        y: i,
        width: s,
        ...
        s.imgwidth = iF(r?.width, iC[h]?.width), s.imgheight = iF(r?.height, iC[h]?.height), l = t => t.attr({
          ...
          s[`${t}Setter`] = function (t, e) {
            ...
            let {
              ...
              l = "width" === e ? n : h,
              d = 1;
            r && "within" === r.backgroundSize && o && a && n && h ? (d = Math.min(o / n, a / h), iL(s, {
          ...
          x: e,
          y: i
        }), s.isImg = !0, s.symbolUrl = t, iD(s.imgwidth) && iD(s.imgheight) ? l(s) : (s.attr({
          width: 0,
          height: 0
        }), iO("img", {
          onload: function () {
    ...
    pathToSegments(t) {
      ...
      for (let o = 0; o < t.length; o++) iH(i[0]) && iR(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")), "string" == typeof t[o] && (i.length && e.push(i.slice(0)), i.length = 0), i.push(t[o]);
  ...
  class i6 extends eJ {
    ...
    constructor(t, e) {
      super(t, e), i6.useForeignObject ? this.foreignObject = t.createElement("foreignObject").attr({
        zIndex: 2
      }) : this.css({
        position: "absolute",
        ...(t.styledMode ? {} : {
    ...
    css(t) {
      let e,
        ...
        o = s && t.width;
      return s && (delete t.width, this.textWidth = i1(o) || void 0, e = !0), t?.textOverflow === "ellipsis" && (t.overflow = "hidden", t.whiteSpace = "nowrap"), t?.lineClamp && (t.display = "-webkit-box", t.WebkitLineClamp = t.lineClamp, t.WebkitBoxOrient = "vertical", t.overflow = "hidden"), i0(Number(t?.fontSize)) && (t.fontSize += "px"), iJ(this.styles, t), i_(i, t), e && this.updateTransform(), this;
    }
    htmlGetBBox() {
      let {
        element: t
    ...
    updateTransform() {
      ...
      if (e || i_(t, {
        ...
        e && (i_(t, {
          ...
          width: s.width,
          height: s.height
        })), u !== this.cTT && (g = s.fontMetrics(t).b, iK(o) && !e && (o !== (this.oldRotation || 0) || c !== this.oldAlign) && i_(t, {
        ...
        (n || h) && (v.transform = `scale(${n ?? 1},${h ?? 1})`), e ? (super.updateTransform(), i0(f) && i0(m) ? (e.attr({
          x: f + y,
          y: m + b,
          ...
          width: 0,
          height: 0
        })) : i_(t, v), this.cTT = u, this.oldRotation = o, this.oldAlign = c;
      }
    }
    add(t) {
      let {
  ...
  let i9 = i6.prototype;
  i9.visibilitySetter = i9.opacitySetter = i3, i9.ySetter = i9.rotationSetter = i9.rotationOriginXSetter = i9.rotationOriginYSetter = i9.xSetter, !function (t) {
    t.xAxis = {
      alignTicks: !0,
  ...
  (a || (a = {})).registerEventOptions = function (t, e) {
    t.eventOptions = t.eventOptions || {}, st(e.events, function (e, i) {
      t.eventOptions[i] !== e && (t.eventOptions[i] && (se(t, i, t.eventOptions[i]), delete t.eventOptions[i]), i7(e) && (t.eventOptions[i] = e, i8(t, i, e, {
        order: 0
      })));
    });
  };
  let si = a,
    ...
    sf = class {
      ...
      addLabel() {
        ...
        } : t.shortenLabel = void 0, p && e._addedPlotLB && t.moveLabel(k, h), sa(u) || t.movedLabel ? u && u.textStr !== k && !p && (!u.textWidth || h.style.width || u.styles.width || u.css({
          width: null
        }), u.attr({
          text: k
      ...
      createLabel(t, e, i) {
        ...
        return n && (r || n.css(sp(e.style)), n.textPxLength = n.getBBox().width, !r && a && n.css({
          whiteSpace: a
        })), n;
      }
      destroy() {
      ...
      getPosition(t, e, i, s) {
        ...
        return n.y = so(n.y, -1e9, 1e9), sl(this, "afterGetPosition", {
          pos: n
        }), n;
      }
      getLabelPosition(t, e, i, s, o, r, a, n) {
        let h,
          ...
          m = o.distance,
          x = {};
        return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? u.y + m : Math.cos(i.rotation * ss) * (u.y - i.getBBox(!1, 0).height / 2), sa(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y), t = t + su(o.x, [0, 1, 0, -1][d.side] * m) + f + u.x - (r && s ? r * c * (p ? -1 : 1) : 0), e = e + h - (r && !s ? r * c * (p ? 1 : -1) : 0), g && (l = a / (n || 1) % g, d.opposite && (l = g - l - 1), e += l * (d.labelOffset / g)), x.x = t, x.y = Math.round(e), sl(this, "afterGetLabelPosition", {
          pos: x,
          tickmarkOffset: r,
          index: a
        }), x;
      ...
      handleOverflow(t) {
        let e = this.axis,
          ...
          u = 1,
          f;
        l || "justify" !== i.overflow ? l < 0 && s - d * c < a ? f = Math.round(s / Math.cos(l * ss) - a) : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * ss))) : (s - d * c < a ? g = t.x + g * (1 - d) - a : s + (1 - d) * c > n && (g = n - t.x + g * d, u = -1), (g = Math.min(p, g)) < p && "center" === e.labelAlign && (t.x += u * (p - g - d * (p - Math.min(c, g)))), (c > g || e.autoRotation && h?.styles?.width) && (f = g)), f && h && (this.shortenLabel ? this.shortenLabel() : h.css(sh({}, {
      ...
      moveLabel(t, e) {
        let i = this,
          ...
          r = !1,
          a;
        s && s.textStr === t ? (i.movedLabel = s, r = !0, delete i.label) : sg(o.ticks, function (e) {
      ...
      render(t, e, i) {
        ...
        !s.chart.polar && (sr(p) < d || p > c) && (i = 0), i ?? (i = 1), this.isActive = !0, this.renderGridLine(e, i), this.renderMark(n, i), this.renderLabel(n, e, g, t), this.isNew = !1, sl(this, "afterRender");
      }
      renderGridLine(t, e) {
        let i = this.axis,
          s = i.options,
      ...
      renderLabel(t, e, i, s) {
        let o = this.axis,
          ...
          p = t.y,
          g = !0;
        n && sc(c) && (n.xy = t = this.getLabelPosition(c, p, n, r, h, d, s, l), (!this.isFirst || this.isLast || a.showFirstLabel) && (!this.isLast || this.isFirst || a.showLastLabel) ? !r || h.step || h.rotation || e || 0 === i || this.handleOverflow(t) : g = !1, l && s % l && (g = !1), g && sc(t.y) ? (t.opacity = i, n[this.isNewLabel ? "attr" : "animate"](t).show(!0), this.isNewLabel = !1) : (n.hide(), this.isNewLabel = !0));
      }
      replaceMovedLabel() {
        let t = this.label,
          e = this.axis;
  ...
  class s$ {
    ...
    init(t, e, i = this.coll) {
      ...
      this.crosshair = !0 === n ? {} : n, -1 === t.axes.indexOf(this) && (s ? t.axes.splice(t.xAxis.length, 0, this) : t.axes.push(this), sD(this, t[this.coll])), t.orderItems(this.coll), this.series = this.series || [], t.inverted && !this.isZAxis && s && !sC(this.reversed) && (this.reversed = !0), this.labelRotation = sN(a.rotation) ? a.rotation : void 0, sv(this, r), sE(this, "afterInit");
    }
    setOptions(t) {
      let e = this.horiz ? {
        labels: {
      ...
      } : {}, sb[this.coll], t), sE(this, "afterSetOptions", {
        userOptions: t
      });
    }
    defaultLabelFormatter() {
      let t = this.axis,
        ...
        c,
        p;
      if (o) p = `${this.value}`;else if (r) p = s.dateFormat(r, i, !0);else if (d && n && l >= 1e3) for (; d-- && void 0 === p;) l >= (c = Math.pow(h, d + 1)) && 10 * i % c == 0 && null !== n[d] && 0 !== i && (p = e(i / c, -1) + n[d]);
        ...
        e.hasVisibleSeries = !1, e.dataMin = e.dataMax = e.threshold = void 0, e.softThreshold = !e.isXAxis, e.series.forEach(i => {
          if (i.reserveSpace()) {
            ...
            if (e.hasVisibleSeries = !0, e.positiveValuesOnly && 0 >= (r || 0) && (r = void 0), e.isXAxis) (o = i.getColumn("x")).length && (o = e.logarithmic ? o.filter(t => t > 0) : o, a = (t = i.getXExtremes(o)).min, n = t.max, sN(a) || a instanceof Date || (o = o.filter(sN), a = (t = i.getXExtremes(o)).min, n = t.max), o.length && (e.dataMin = Math.min(sX(e.dataMin, a), a), e.dataMax = Math.max(sX(e.dataMax, n), n)));else {
              ...
              sN(t.dataMin) && (a = t.dataMin, e.dataMin = Math.min(sX(e.dataMin, a), a)), sN(t.dataMax) && (n = t.dataMax, e.dataMax = Math.max(sX(e.dataMax, n), n)), sC(r) && (e.threshold = r), (!s.softThreshold || e.positiveValuesOnly) && (e.softThreshold = !1);
            }
          }
        });
    ...
    translate(t, e, i, s, o, r) {
      ...
      let h = a.minPixelPadding,
        ...
        g = 0;
      return p || (p = a.transA), i && (d *= -1, c = a.len), a.reversed && (d *= -1, c -= d * (a.sector || a.len)), e ? (g = (t = t * d + c - h) / p + n, l && (g = a.lin2val(g))) : (l && (t = a.val2lin(t)), g = d * (t - n) * p + c + d * h + (sN(r) ? p * r : 0), a.isRadial || (g = sT(g))), g;
    }
    toPixels(t, e) {
    ...
    getPlotLinePath(t) {
      ...
      return sE(this, "getPlotLinePath", b, function (t) {
        g = f = (c = sS(c = sX(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d, u = m = h - c - d, sN(c) ? e.horiz ? (u = o, m = h - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), g = f = y(g, s, s + e.width)) : (g = s, f = l - e.right + (i.scrollablePixelsX || 0), u = m = y(u, o, o + e.height)) : (x = !0, p = !1), t.path = x && !p ? void 0 : i.renderer.crispLine([["M", g, u], ["L", f, m]], n || 1);
      }), b.path;
    }
    ...
    getMinorTickPositions() {
      ...
      if (a && a / i < this.len / 3) {
        ...
        });else if (this.dateTime && "auto" === this.getMinorTickInterval()) n = n.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(i), o, r, t.startOfWeek));else for (h = o + (e[0] - o) % i; h <= r && h !== n[0]; h += i) n.push(h);
      }
    ...
    adjustForMinRange() {
      ...
      })) || 0), this.dataMax - this.dataMin)), sN(s) && sN(o) && sN(r) && s - o < r && (n = this.dataMax - this.dataMin >= r, a = (r - s + o) / 2, h = [o - a, i.parse(t.min) ?? o - a], n && (h[2] = e ? e.log2lin(this.dataMin) : this.dataMin), l = [(o = sw(h)) + r, i.parse(t.max) ?? o + r], n && (l[2] = e ? e.log2lin(this.dataMax) : this.dataMax), (s = sM(l)) - o < r && (h[0] = s - r, h[1] = i.parse(t.min) ?? s - r, o = sw(h))), this.minRange = r, this.min = o, this.max = s;
    }
    getClosest() {
      let t, e;
    ...
    nameToX(t) {
      let e = sB(this.options.categories),
        ...
        s = t.options.x,
        o;
      return t.series.requireSorting = !1, sC(s) || (s = this.uniqueNames && i ? e ? i.indexOf(t.name) : sX(i.keys[t.name], -1) : t.series.autoIncrement()), -1 === s ? !e && i && (o = i.length) : sN(s) && (o = s), void 0 !== o ? (this.names[o] = t.name, this.names.keys[t.name] = o) : t.x && (o = t.x), o;
    }
    updateNames() {
      let t = this,
        e = this.names;
    ...
    setAxisTranslation() {
      ...
      (o || s || r) && (a = t.getClosest(), i ? (n = i.minPointOffset, h = i.pointRangePadding) : t.series.forEach(function (e) {
        ...
        if (r = Math.max(r, i), !t.single || s) {
          ...
          n = Math.max(n, t && sz(l) ? 0 : i / 2), h = Math.max(h, t && "on" === l ? 0 : i);
        }
      }), l = t.ordinal?.slope && a ? t.ordinal.slope / a : 1, t.minPointOffset = n *= l, t.pointRangePadding = h *= l, t.pointRange = Math.min(r, t.single && s ? 1 : e), o && (t.closestPointRange = a)), t.translationSlope = t.transA = d = t.staticScale || t.len / (e + h || 1), t.transB = t.horiz ? t.left : t.bottom, t.minPixelPadding = d * n, sE(this, "afterSetAxisTranslation");
    }
    minFromRange() {
      let {
        max: t,
    ...
    setTickPositions() {
      let t = this.options,
        ...
        n = [],
        h;
      if (this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ? .5 : 0, this.single = this.min === this.max && sC(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals), e) n = e.slice();else if (sN(this.min) && sN(this.max)) {
        if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n = [this.min, this.max], sL(19, !1, this.chart);else if (this.dateTime) n = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t.units), this.min, this.max, t.startOfWeek, this.ordinal?.positions, this.closestPointRange, !0);else if (this.logarithmic) n = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);else {
          let t = this.tickInterval,
            e = t;
          for (; e <= 2 * t;) if (n = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && n.length > this.tickAmount) this.tickInterval = sU(this, e *= 1.1);else break;
        }
        n.length > this.len && (n = [n[0], n[n.length - 1]])[0] === n[1] && (n.length = 1), i && (this.tickPositions = n, (h = i.apply(this, [this.min, this.max])) && (n = h));
      }
      this.tickPositions = n, this.minorTickInterval = "auto" === s && this.tickInterval ? this.tickInterval / t.minorTicksPerMajor : s, this.paddedTicks = n.slice(0), this.trimTicks(n, r, a), !this.isLinked && sN(this.min) && sN(this.max) && (this.single && n.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5, this.max += .5), e || h || this.adjustTickAmount()), sE(this, "afterSetTickPositions");
    }
    trimTicks(t, e, i) {
      let s = t[0],
        o = t[t.length - 1],
    ...
    getThresholdAlignment(t) {
      if ((!sN(this.dataMin) || this !== t && this.series.some(t => t.isDirty || t.isDirtyData)) && this.getSeriesExtremes(), sN(this.threshold)) {
    ...
    getTickAmount() {
      let t = this.options,
        ...
        i = t.tickAmount;
      sC(t.tickInterval) || i || !(this.len < e) || this.isRadial || this.logarithmic || !t.startOnTick || !t.endOnTick || (i = 2), !i && this.alignToOthers() && (i = Math.ceil(this.len / e) + 1), i < 4 && (this.finalTickAmt = i, i = 5), this.tickAmount = i;
    }
    adjustTickAmount() {
      let t = this,
        {
      ...
      if (sN(n) && (g = n < .5 ? Math.ceil(n * (a - 1)) : Math.floor(n * (a - 1)), o.reversed && (g = a - 1 - g)), t.hasData() && sN(s) && sN(i)) {
        let n = () => {
    ...
    setScale() {
      ...
      o || i || s || this.isLinked || this.forceRedraw || this.userMin !== this.old?.userMin || this.userMax !== this.old?.userMax || this.alignToOthers() ? (e && "yAxis" === t && e.buildStacks(), this.forceRedraw = !1, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), e && "xAxis" === t && e.buildStacks(), this.isDirty || (this.isDirty = o || this.min !== this.old?.min || this.max !== this.old?.max)) : e && e.cleanStacks(), i && delete this.allExtremes, sE(this, "afterSetScale");
    }
    ...
    unsquish() {
      let t = this.options.labels,
        ...
        r = t.rotation,
        a = sT(.8 * this.labelMetrics().h),
        n = Math.max(this.max - this.min, 0),
        h = function (t) {
          let i = (t + 2 * e) / (o || 1);
          return (i = i > 1 ? Math.ceil(i) : 1) * s > n && t !== 1 / 0 && o !== 1 / 0 && n && (i = Math.ceil(n / s)), sT(i * s);
        },
        l = s,
        d,
        c = Number.MAX_VALUE,
        p;
      if (i) {
        if (!t.staggerLines && (sN(r) ? p = [r] : o < t.autoRotationLimit && (p = t.autoRotation)), p) {
          let t, e;
    ...
    renderUnsquish() {
      let t = this.chart,
        ...
        u = 0;
      sz(o.rotation) || (l.rotation = o.rotation || 0), i.forEach(function (t) {
        let e = s[t];
        ...
        let e = s[t],
          ...
          o = r.width,
          a = {};
        i && (i.attr(l), e.shortenLabel ? e.shortenLabel() : p && !o && "nowrap" !== r.whiteSpace && (p < (i.textPxLength || 0) || "SPAN" === i.element.tagName) ? i.css(sO(a, {
          width: `${p}px`,
          lineClamp: g
    ...
    addTitle(t) {
      ...
      this.axisTitle || ((e = r.textAlign) || (e = (s ? {
        ...
        align: e
      }).addClass("highcharts-axis-title"), a || this.axisTitle.css(sR(r.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0), a || r.style.width || this.isRadial || this.axisTitle.css({
        width: this.len + "px"
    ...
    getOffset() {
      ...
      }), d?.text && !1 !== d.enabled && (t.addTitle(m), m && !p && !1 !== d.reserveSpace && (t.titleOffset = x = t.axisTitle.getBBox()[i ? "height" : "width"], b = sC(y = d.offset) ? 0 : sX(d.margin, i ? 5 : 10))), t.renderLine(), t.offset = f * sX(s.offset, g[o] ? g[o] + (s.margin || 0) : 0), t.tickRotCorr = t.tickRotCorr || {
        x: 0,
        y: 0
    ...
    renderMinorTick(t, e) {
      ...
      i[t] || (i[t] = new sf(this, t, "minor")), e && i[t].isNew && i[t].render(null, !0), i[t].render(null, !1, 1);
    }
    renderTick(t, e, i) {
      let s = this.isLinked,
        o = this.ticks;
      (!s || t >= this.min && t <= this.max || this.grid?.isColumn) && (o[t] || (o[t] = new sf(this, t)), i && o[t].isNew && o[t].render(e, !0, -1), o[t].render(e));
    }
    render() {
      let t,
        e,
      ...
      if (i.hasData() || n) {
        ...
        i.minorTickInterval && !i.categories && i.getMinorTickPositions().forEach(function (t) {
          ...
          i.renderTick(t, e, r);
        }), m && (0 === i.min || i.single) && (d[-1] || (d[-1] = new sf(i, -1, null, !0)), d[-1].render(-1))), u && h.forEach(function (r, a) {
          e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m, a % 2 == 0 && r < i.max && e <= i.max + (s.polar ? -m : m) && (p[r] || (p[r] = new w.PlotLineOrBand(i, {})), t = r + m, p[r].options = {
      ...
      }), x.isPlaced = !0, x[y ? "show" : "hide"](y)), l && y && (l[l.isNew ? "attr" : "animate"](i.getTitlePosition(l)), l.isNew = !1), g?.enabled && i.stacking && i.stacking.renderStackTotals(), i.old = {
        len: i.len,
        max: i.max,
        min: i.min,
        transA: i.transA,
    ...
    destroy(t) {
      ...
      if (sE(this, "destroy", {
        keepEvents: t
      }), t || sG(e), [e.ticks, e.minorTicks, e.alternateBands].forEach(function (t) {
        sA(t);
      }), i) {
        let t = i.length;
        for (; t--;) i[t].destroy();
    ...
    update(t, e) {
      let i = this.chart;
      t = sR(this.userOptions, t), this.destroy(!0), this.init(i, t), i.isDirtyBox = !0, sX(e, !0) && i.redraw();
    }
    remove(t) {
      let e = this.chart,
        i = this.coll,
      ...
      sP(e.axes, this), sP(e[i] || [], this), e.orderItems(i), this.destroy(), e.isDirtyBox = !0, sX(t, !0) && e.redraw();
    }
    setTitle(t, e) {
      this.update({
        title: t
    ...
    class s {
      ...
      normalizeTimeTickInterval(t, e) {
        let i = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]],
          ...
          r = s[1],
          a;
        for (a = 0; a < i.length && (o = sq[(s = i[a])[0]], r = s[1], !i[a + 1] || !(t <= (o * r[r.length - 1] + sq[i[a + 1][0]]) / 2)); a++);
  ...
  !function (t) {
    ...
    t.compose = function (t) {
      return t.keepProps.includes("logarithmic") || (t.keepProps.push("logarithmic"), sJ(t, "afterSetType", e), sJ(t, "afterInit", i)), t;
    };
    class s {
      constructor(t) {
        this.axis = t;
      ...
      getLogTickPositions(t, e, i, s) {
        ...
        if (s || (this.minorAutoInterval = void 0), t >= .5) t = Math.round(t), n = o.getLinearTickPositions(t, e, i);else if (t >= .08) {
          let o,
            ...
            c,
            p = Math.floor(e);
          for (o = t > .3 ? [1, 2, 4] : t > .15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], r = p; r < i + 1 && !c; r++) for (a = 0, h = o.length; a < h && !c; a++) (l = this.log2lin(this.lin2log(r) * o[a])) > e && (!s || d <= i) && void 0 !== d && n.push(d), d > i && (c = !0), d = l;
        } else {
          ...
          t = sQ(t = s0("auto" === d ? null : d, this.minorAutoInterval, (l - h) * c / (p || 1))), n = o.getLinearTickPositions(t, h, l).map(this.log2lin), s || (this.minorAutoInterval = t / 5);
        }
  ...
  !function (t) {
    ...
    function r(t, e, i) {
      ...
      let s = this.getPlotLinePath({
        ...
        o = [],
        r = this.horiz,
        a = !s5(this.min) || !s5(this.max) || t < this.min && e < this.min || t > this.max && e > this.max,
  ...
  class oa {
    ...
    render() {
      ...
      let {
        ...
        M = b ? "bands" : "lines";
      if (!t.chart.styledMode && (v ? (w.stroke = o || "#999999", w["stroke-width"] = or(e.width, 1), e.dashStyle && (w.dashstyle = e.dashStyle)) : b && (w.fill = o || "#e6e9ff", g && (w.stroke = e.borderColor, w["stroke-width"] = g))), l.zIndex = a, M += "-" + a, (y = t.plotLinesAndBandsGroups[M]) || (t.plotLinesAndBandsGroups[M] = y = n.g("plot-" + M).attr(l).add()), m || (this.svgElem = m = n.path().attr(w).add(y)), s7(p)) x = t.getPlotLinePath({
        value: s?.log2lin(p) ?? p,
      ...
      return !this.eventsAdded && r && (oo(r, (t, e) => {
        ...
        d: x
      })) : m.d && (m.hide(), f && (this.label = f = f.destroy()))), u && (s7(u.text) || s7(u.formatter)) && x?.length && t.width > 0 && t.height > 0 && !x.isFlat ? (u = os({
    ...
    renderLabel(t, e, i, s) {
      ...
      n.align(t, !1, {
        ...
        width: p,
        height: s4(l) - c
      }), n.alignAttr.y -= r.fontMetrics(n).b, (!n.alignValue || "left" === n.alignValue || s7(a)) && n.css({
  ...
  class oO {
    ...
    destroy() {
      this.label && (this.label = this.label.destroy()), this.split && (this.cleanSplit(!0), this.tt && (this.tt = this.tt.destroy())), this.renderer && (this.renderer = this.renderer.destroy(), ox(this.container)), V.clearTimeout(this.hideTimer);
    }
    getAnchor(t, e) {
      let i,
        {
        ...
        a = s.plotTop,
        n = s.plotLeft;
      if (t = oP(t), t[0].series?.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e) void 0 === e.chartX && (e = o.normalize(e)), i = [e.chartX - n, e.chartY - a];else if (t[0].tooltipPos) i = t[0].tooltipPos;else {
        let s = 0,
          o = 0;
    ...
    getLabel({
      ...
      if (!this.label) {
        if (this.outside) {
          ...
          this.container = a = w.doc.createElement("div"), a.className = "highcharts-tooltip-container " + (t.renderTo.className.match(/(highcharts[a-zA-Z0-9-]+)\s?/gm) || ""), om(a, {
            position: "absolute",
            top: "1px",
            pointerEvents: "none",
      ...
      let T = !this.followPointer && oC(i.ttBelow, !d && !n === S),
        C = function (t, e, i, o, a, n, h) {
          let l = r ? "y" === t ? b(s) : y(s) : s,
            ...
            f = a - l - i + d,
            m = a + l - d;
          if (T && p) g[t] = m;else if (!T && c) g[t] = f;else if (c) g[t] = Math.min(h - o, f - u < 0 ? f : f - u);else {
            if (!p) return g[t] = 0, !1;
    ...
    hide(t) {
      let e = this;
      V.clearTimeout(this.hideTimer), t = oC(t, this.options.hideDelay), this.isHidden || (this.hideTimer = oL(function () {
        let i = e.getLabel();
        e.getLabel().animate({
          opacity: 0
        }, {
    ...
    init(t, e) {
      this.chart = t, this.options = e, this.crosshairs = [], this.isHidden = !0, this.split = e.split && !t.inverted && !t.polar, this.shared = e.shared || this.split, this.outside = oC(e.outside, !!(t.scrollablePixelsX || t.scrollablePixelsY));
    }
    ...
    refresh(t, e) {
      ...
      V.clearTimeout(this.hideTimer), this.allowShared = !(!ok(t) && t.series && t.series.noSharedTooltip), c = c && !this.allowShared, this.followPointer = !this.split && n.series.tooltipOptions.followPointer;
      ...
      n.points = void 0;
      let m = n.series;
      if (this.distance = oC(m.tooltipOptions.distance, 16), !1 === f) this.hide();else {
    ...
    renderSplit(t, e) {
      let i = this,
        ...
        O = function (t, e, s, o = [0, 0], r = !0) {
          let a, n;
          if (s.isHeader) n = M ? 0 : L, a = of(o[0] - t / 2, v.left, v.right - t - (i.outside ? S : 0));else if (u && s) {
            let o = i.getFixedPosition(t, e, s);
            a = o.x, n = o.y - A;
          } else n = o[1] - A, a = of(a = r ? o[0] - t - p : o[0] + p, r ? a : v.left, v.right);
          return {
            x: a,
            y: n
          };
      ...
      let E = t.slice(0, e.length + 1).reduce(function (t, s, o) {
        if (!1 !== s && "" !== s) {
          let r = e[o - 1] || {
            ...
            f = d.tt = function (t, e, s) {
              ...
              if (!o) {
                ...
                c || (t.fill = n.backgroundColor, t["stroke-width"] = n.borderWidth ?? (u && !r ? 0 : 1)), o = w.label("", 0, 0, n[r ? "headerShape" : "shape"] || (u && !r ? "rect" : "callout"), void 0, void 0, n.useHTML).addClass(i.getClassName(e, !0, r)).attr(t).add(k);
              }
          ...
          let {
            ...
            if (s) e = Math.max(n + o, n), i = h + a / 2;else {
              let {
                xAxis: t,
                yAxis: s
              } = l;
              e = t.pos + of(o, -p, t.len + p), l.shouldShowTooltip(0, s.pos - h + r, {
                ignoreX: !0
              }) && (i = s.pos + r);
            }
            return {
      ...
      !C && E.some(t => {
        ...
        let {
          x: e,
          y: i
        } = O.call(this, t.boxWidth, t.size, t.point, [t.anchorX, t.anchorY], !1);
        return oy(t, {
          target: i,
          x: e
        });
      ...
      E.forEach(function (t) {
        ...
        !o && (i.outside && S + e < I.left && (I.left = S + e), !o && i.outside && I.left + s > I.right && (I.right = S + e));
      }), E.forEach(function (t) {
        let {
            x: e,
            anchorX: s,
        ...
        if (i.outside && e < s) {
          let t = S - I.left;
          t > 0 && (a || (n.x = e + t, n.anchorX = s + t), a && (n.x = (I.right - I.left) / 2, n.anchorX = s + t));
        }
        t.tt.attr(n);
      });
      let {
    ...
    headerFooterFormatter(t, e) {
      ...
      return ob(this, "headerFormatter", a, function (e) {
        if (r && !n && ow(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)), r && n) {
          if (oM(n)) {
            let t = n;
    ...
    updatePosition(t) {
      ...
      if (a && i) {
        ...
        b = (o.borderWidth || 0) + 2 * s + 2, a.setSize(of(h + b, 0, m.documentElement.clientWidth) - 1, n + b, !1), (1 !== g || 1 !== u) && (om(i, {
          transform: `scale(${g}, ${u})`
        }), x *= g, y *= u), x += c - f.x, y += p - f.y;
      }
  ...
  class oq {
    ...
    applyOptions(t, e) {
      ...
      return oW(this, t = oq.prototype.optionsToObject.call(this, t)), this.options = this.options ? oW(this.options, t) : t, t.group && delete this.group, t.dataLabels && delete this.dataLabels, s && (this.y = oq.prototype.getNestedProperty.call(this, s)), this.selected && (this.state = "select"), "name" in this && void 0 === e && i.xAxis && i.xAxis.hasNames && (this.x = i.xAxis.nameToX(this)), void 0 === this.x && i ? this.x = e ?? i.autoIncrement() : oj(t.x) && i.options.relativeXValue ? this.x = i.autoIncrement(t.x) : "string" == typeof this.x && (e ?? (e = i.chart.time.parse(this.x)), oj(e) && (this.x = e)), this.isNull = this.isValid && !this.isValid(), this.formatPrefix = this.isNull ? "null" : "point", this;
    }
    destroy() {
      if (!this.destroyed) {
        let t = this,
          ...
          a = () => {
            for (let e in (t.graphic || t.graphics || t.dataLabel || t.dataLabels) && (oZ(t), t.destroyElements()), t) delete t[e];
          };
        t.legendItem && i.legend.destroyItem(t), o && (t.setState(), oR(o, t), o.length || (i.hoverPoints = null)), t === i.hoverPoint && t.onMouseOut(), s?.enabled ? (this.animateBeforeDestroy(), oV(a, r.duration)) : a(), i.pointCount--;
      }
      this.destroyed = !0;
    }
    destroyElements(t) {
    ...
    constructor(t, e, i) {
      this.formatPrefix = "point", this.visible = !0, this.point = this, this.series = t, this.applyOptions(e, i), this.id ?? (this.id = o_()), this.resolveColor(), this.dataLabelOnNull ?? (this.dataLabelOnNull = t.options.nullInteraction), t.chart.pointCount++, oH(this, "afterInit");
    }
    isValid() {
    ...
    optionsToObject(t) {
      let e = this.series,
        ...
        n = 0,
        h = 0;
      if (oj(t) || null === t) r[s[0]] = t;else if (oF(t)) for (!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis?.dateTime ? r.x = e.chart.time.parse(t[0]) : r.name = t[0] : "number" === a && (r.x = t[0]), n++); h < o;) i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? oq.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]), n++, h++;else "object" == typeof t && (r = t, t.dataLabels && (e.hasDataLabels = () => !0), t.marker && (e._hasPointMarkers = !0));
      return r;
    }
    pos(t, e = this.plotY) {
      if (!this.destroyed) {
        let {
          ...
          n = 0,
          h = 0;
        if (oj(i) && oj(e)) return t && (n = r ? r.pos : o.plotLeft, h = a ? a.pos : o.plotTop), o.inverted && r && a ? [a.len - e + h, r.len - i + n] : [i + n, e + h];
      }
    }
    resolveColor() {
      let t = this.series,
        ...
        r = e.colorCount,
        a;
      delete this.nonZonedColor, t.options.colorByPoint ? (i || (s = (o = t.options.colors || t.chart.options.colors)[t.colorCounter], r = o.length), a = t.colorCounter, t.colorCounter++, t.colorCounter === r && (t.colorCounter = 0)) : (i || (s = t.color), a = t.colorIndex), this.colorIndex = o$(this.options.colorIndex, a), this.color = o$(this.options.color, s);
    }
    ...
    update(t, e, i, s) {
      ...
      function d() {
        ...
        let s = n && r.hasMockGraphic,
          d = null === r.y ? !s : s;
        n && d && (r.graphic = n.destroy(), delete r.hasMockGraphic), oY(t, !0) && (n?.element && t && t.marker && void 0 !== t.marker.symbol && (r.graphic = n.destroy()), t?.dataLabels && r.dataLabel && (r.dataLabel = r.dataLabel.destroy())), o = r.index;
        let c = {};
        for (let t of a.dataColumnKeys()) c[t] = r[t];
        a.dataTable.setRow(c, o), l.data[o] = oY(l.data[o], !0) || oY(t, !0) ? r.options : o$(t, l.data[o]), a.isDirty = a.isDirtyData = !0, !a.fixedBox && a.hasCartesianSeries && (h.isDirtyBox = !0), "point" === l.legendType && (h.isDirtyLegend = !0), e && h.redraw(i);
      }
      e = o$(e, !0), !1 === s ? d() : r.firePointEvent("update", {
        options: t
      }, d);
    }
    remove(t, e) {
    ...
    select(t, e) {
      let i = this,
        s = i.series,
        o = s.chart;
      t = o$(t, !i.selected), this.selectedStaging = t, i.firePointEvent(t ? "select" : "unselect", {
        accumulate: e
      }, function () {
    ...
    manageEvent(t) {
      let e = oU(this.series.options.point, this.options),
        i = e.events?.[t];
      oG(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1) ? (this.importedUserEvent?.(), this.importedUserEvent = oN(this, t, i), this.hcEvents && (this.hcEvents[t].userEvent = !0)) : this.importedUserEvent && !i && this.hcEvents?.[t] && this.hcEvents?.[t].userEvent && (oZ(this, t), delete this.hcEvents[t], Object.keys(this.hcEvents) || delete this.importedUserEvent);
    }
    setState(t, e) {
      let i = this.series,
        s = this.state,
      ...
      if (this.state = t, c && (g = i.markerAttribs(this, t)), this.graphic && !this.hasMockGraphic) {
        ...
        g && this.graphic.animate(g, o$(d.options.chart.animation, n.animation, r.animation)), m && m.hide();
      } else t && n && (x = l.symbol || i.symbol, m && m.currentSymbol !== x && (m = m.destroy()), g && (m ? m[e ? "animate" : "attr"]({
        x: g.x,
        y: g.y
      }) : x && (i.stateMarkerGraphic = m = d.renderer.symbol(x, g.x, g.y, g.width, g.height, oU(r, n)).add(i.markerGroup), m.currentSymbol = x)), !d.styledMode && m && "inactive" !== this.state && m.attr(i.pointAttribs(this, t))), m && (m[t && this.isInside ? "show" : "hide"](), m.element.point = this, m.addClass(this.getClassName(), !0));
      let y = o.halo,
        b = this.graphic || m,
      ...
      y?.size && b && "hidden" !== v && !this.isCluster ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)), p.show()[e ? "animate" : "attr"]({
        ...
        visibility: v,
        zIndex: -1
      }), p.point = this, d.styledMode || p.attr(oW({
      ...
      }, null, p.hide), oH(this, "afterSetState", {
        state: t
      });
    }
    haloPath(t) {
  ...
  class rr {
    ...
    destroy() {
      let t = this;
      this.eventsToUnbind.forEach(t => t()), this.eventsToUnbind = [], !w.chartCount && (rr.unbindDocumentMouseUp.forEach(t => t.unbind()), rr.unbindDocumentMouseUp.length = 0, rr.unbindDocumentTouchEnd && (rr.unbindDocumentTouchEnd = rr.unbindDocumentTouchEnd())), clearInterval(t.tooltipTimeout), rt(t, function (e, i) {
        t[i] = void 0;
      });
    }
    ...
    getChartCoordinatesFromPoint(t, e) {
      ...
      if (i && s) {
        let r = t.clientX ?? t.plotX ?? 0,
          a = t.plotY || 0;
        return t.isNode && o && o8(o.x) && o8(o.y) && (r = o.x, a = o.y), e ? {
    ...
    getHoverData(t, e, i, s, o, r) {
      ...
      o4(this, "beforeGetHoverData", d), l = h && !h.stickyTracking ? [h] : i.filter(t => t.stickyTracking && (d.filter || n)(t));
      ...
      }) : a.push(c)), o4(this, "afterGetHoverData", d = {
        hoverPoint: c
      }), {
    ...
    constructor(t, e) {
      this.hasDragged = 0, this.pointerCaptureEventsToUnbind = [], this.eventsToUnbind = [], this.options = e, this.chart = t, this.runChartClick = !!e.chart.events?.click, this.pinchDown = [], this.setDOMEvents(), o4(this, "afterInit");
    }
    normalize(t, e) {
      let i = t.touches,
    ...
    onContainerClick(t) {
      ...
      !e.cancelClick && (i && this.inClass(s.target, "highcharts-tracker") ? (o4(i.series, "click", o6(s, {
        point: i
      })), e.hoverPoint && i.firePointEvent("click", s)) : (o6(s, this.getCoordinates(s)), e.isInsidePlot(s.chartX - o, s.chartY - r, {
        visiblePlotOnly: !0
      }) && o4(e, "click", s)));
    }
    onContainerMouseDown(t) {
      let e = (1 & (t.buttons || t.button)) == 1;
      t = this.normalize(t), w.isFirefox && 0 !== t.button && this.onContainerMouseMove(t), (void 0 === t.button || e) && (this.zoomOption(t), e && t.preventDefault?.(), this.dragStart(t));
    }
    ...
    pinch(t) {
      ...
      a > 1 ? e.initiated = !0 : l && (e.initiated = !1), s && e.initiated && !n && !1 !== t.cancelable && t.preventDefault(), "touchstart" === t.type ? (e.pinchDown = r, e.res = !0, i.mouseDownX = t.chartX) : l ? this.runPointActions(e.normalize(t)) : o && (o4(i, "touchpan", {
        originalEvent: t,
        touches: r
      }, () => {
        let e = t => {
    ...
    reset(t, e) {
      ...
      }), t ? a && n && ro(n).length && (a.refresh(n), a.shared && r ? r.forEach(function (t) {
    ...
    setPointerCapture() {
      ...
      !this.hasPointerCapture && s ? (t.push(o2(i, "pointerdown", t => {
        ...
        "touch-action": "none"
      }), i.className += " highcharts-no-touch-action", this.hasPointerCapture = !0) : this.hasPointerCapture && !s && (t.forEach(t => t()), t.length = 0, e.styledMode || o5(i, {
    ...
    touch(t, e) {
      ...
      this.setHoverChartIndex(), 1 === (t = this.normalize(t)).touches.length ? s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {
        visiblePlotOnly: !0
      }) && !s.exporting?.openMenu ? (e && this.runPointActions(t), "touchmove" === t.type && (this.hasPinchMoved = i = !!o[0] && Math.pow(o[0].chartX - t.chartX, 2) + Math.pow(o[0].chartY - t.chartY, 2) >= 16), ri(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t);
    }
    touchSelect(t) {
    ...
    zoomOption(t) {
      let e = this.chart,
        ...
        o,
        r;
      /touch/.test(t.type) && (s = ri(e.zooming.pinchType, s)), this.zoomX = o = /x/.test(s), this.zoomY = r = /y/.test(s), this.zoomHor = o && !i || r && i, this.zoomVert = r && !i || o && i, this.hasZoom = o || r;
    }
  }
  rr.unbindDocumentMouseUp = [], function (t) {
    t.compose = function (e) {
  ...
  let {
    ...
    rp = class {
      constructor(t = {}) {
        this.autoId = !t.id, this.columns = {}, this.id = t.id || rc(), this.modified = this, this.rowCount = 0, this.versionTag = rc();
        let e = 0;
        rd(t.columns || {}, (t, i) => {
      ...
      setColumns(t, e, i) {
        ...
        }), this.applyRowCount(s), i?.silent || (rl(this, "afterSetColumns"), this.versionTag = rc());
      }
      setRow(t, e = this.rowCount, i, s) {
        ...
        }), r > this.rowCount && this.applyRowCount(r), s?.silent || (rl(this, "afterSetRows"), this.versionTag = rc());
      }
    },
    {
      extend: rg,
  ...
  !function (t) {
    function e(t, e, i) {
      let s = this.legendItem = this.legendItem || {},
        ...
        c = o.renderer,
        p = s.group,
        g = a - Math.round((t.fontMetrics?.b || h) * (i ? .4 : .3)),
        u = {},
        f,
        m = r.marker,
        x = 0;
      ...
      if (m && !1 !== m.enabled && n) {
        ...
        0 === l.indexOf("url") && (m = ru(m, {
          width: h,
          height: h
        }), t = 0), s.symbol = f = c.symbol(l, n / 2 - t, g - t, 2 * t, 2 * t, rg({
          context: "legend"
  ...
  !function (t) {
    function e(e, i) {
      let s = rx.plotOptions || {},
        o = i.defaultOptions,
        r = i.prototype;
      return r.type = e, r.pointClass || (r.pointClass = oK), !t.seriesTypes[e] && (o && (s[e] = o), t.seriesTypes[e] = i, !0);
    }
  ...
  class r0 {
    ...
    init(t, e) {
      ...
      let a = o.events;
      (a?.click || o.point?.events?.click || o.allowPointSelect) && (t.runTrackerClick = !0), this.getColor(), this.getSymbol(), this.isCartesian && (t.hasCartesianSeries = !0), s.length && (i = s[s.length - 1]), this._i = rK(i?._i, -1) + 1, this.opacity = this.options.opacity, t.orderItems("series", rU(this, s)), o.dataSorting?.enabled ? this.setDataSortingOptions() : this.points || this.data || this.setData(o.data, !1), rG(this, "afterInit");
    }
    is(t) {
      ...
      rG(this, "bindAxes", null, function () {
        (e.axisTypes || []).forEach(function (o) {
          (s[o] || []).forEach(function (s) {
            t = s.options, (rK(i[o], 0) === s.index || void 0 !== i[o] && i[o] === t.id) && (rU(e, s.series), e[o] = s, s.isDirty = !0);
    ...
    autoIncrement(t) {
      ...
      if (this.pointInterval = e = rK(this.pointInterval, i.pointInterval, 1), o && rV(t) && (e *= t), s) {
        let t = r.toParts(a);
    ...
    setOptions(t) {
      ...
      this.tooltipOptions = r_(rS.tooltip, rS.plotOptions.series?.tooltip, c?.tooltip, i.userOptions.tooltip, l.series?.tooltip, p.tooltip, r.tooltip), this.stickyTracking = rK(r.stickyTracking, p.stickyTracking, d.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || g.stickyTracking), null === h.marker && delete g.marker, this.zoneAxis = g.zoneAxis || "y";
      ...
      }, a || (e.color = g.negativeColor, e.fillColor = g.negativeFillColor), u.push(e)), u.length && rN(u[u.length - 1].value) && u.push(a ? {} : {
        color: this.color,
    ...
    getCyclic(t, e, i) {
      ...
      !e && (rN(o = rK("color" === t ? this.options.colorIndex : void 0, this[a])) ? s = o : (r.series.length || (r[n] = 0), s = r[n] % h, r[n] += 1), i && (e = i[s])), void 0 !== s && (this[a] = s), this[t] = e;
    }
    getColor() {
    ...
    findPointIndex(t, e) {
      ...
      return i && void 0 !== (o = i?.index) && (s = !0), void 0 === o && rV(a) && (o = this.getColumn("x").indexOf(a, e)), -1 !== o && void 0 !== o && this.cropped && (o = o >= l ? o - l : o), !s && rV(o) && n[o]?.touched && (o = void 0), o;
    }
    updateData(t, e) {
      let {
          options: i,
      ...
      if (this.xIncrement = null, t.forEach((t, e) => {
        let l,
          d = rN(t) && this.pointClass.prototype.optionsToObject.call({
            series: this
          }, t) || {},
          {
            id: p,
        ...
        p || rV(g) ? (-1 === (l = this.findPointIndex(d, c)) || void 0 === l ? a.push(t) : r[l] && t !== i.data?.[l] ? (r[l].update(t, !1, void 0, !1), r[l].touched = !0, s && (c = l + 1)) : r[l] && (r[l].touched = !0), (!n || e !== l || o?.enabled || this.hasDerivedData) && (h = !0)) : a.push(t);
      }, this), h) for (l = r.length; l--;) (d = r[l]) && !d.touched && d.remove?.(!1, e);else n && !o?.enabled ? (t.forEach((t, e) => {
      ...
      return null === this.xIncrement && g.length && (this.xIncrement = rO(g), this.autoIncrement()), !0;
    }
    dataColumnKeys() {
    ...
    setData(t, e = !0, i, s) {
      let o = this.points,
        ...
        b = 1,
        v;
      n.options.chart.allowMutatingData || (a.data && delete this.options.data, this.userOptions.data && delete this.userOptions.data, v = r_(!0, t));
      let k = (t = v || t || []).length;
      if (h?.enabled && (t = this.sortData(t)), n.options.chart.allowMutatingData && !1 !== s && k && r && !this.cropped && !this.hasGroupedData && this.visible && !this.boosted && (x = this.updateData(t, i)), !x) {
        ...
        for (rZ(this.getColumn("y")[0]) && rH(14, !0, n), this.data = [], this.options.data = this.userOptions.data = t, m = r; m--;) o[m]?.destroy();
    ...
    getProcessedData(t) {
      let e = this,
        ...
        x = i,
        y = !1;
      return r && (u = (g = r.getExtremes()).min, f = g.max, y = !!(r.categories && !r.names.length), s && e.sorted && !n && (!a || l > a || e.forceCrop) && (m[l - 1] < u || m[0] > f ? x = new rp() : e.getColumn(e.pointValKey || "y").length && (m[0] < u || m[l - 1] > f) && (x = (d = this.cropData(i, u, f)).modified, p = d.start, c = !0))), m = x.getColumn("x") || [], {
        modified: x,
        cropped: c,
        cropStart: p,
    ...
    processData(t) {
      ...
      i.modified = s.modified, this.cropped = s.cropped, this.cropStart = s.cropStart, this.closestPointRange = this.basePointRange = s.closestPointRange, rG(this, "afterProcessData");
    }
    cropData(t, e, i) {
    ...
    getExtremes(t, e) {
      let {
        ...
        h = n ? [n] : (this.keysAffectYAxis || this.pointArrayMap || ["y"])?.map(t => r.getColumn(t, !0) || []) || [],
    ...
    afterAnimate() {
      this.setClip(), rq(this.chart.sharedClips, (t, e, i) => {
        t && !this.chart.container.querySelector(`[clip-path="url(#${t.id})"]`) && (t.destroy(), delete i[e]);
      }), this.finishedAnimating = !0, rG(this, "afterAnimate");
    }
    drawPoints(t = this.points) {
      let e,
        ...
        f = this.xAxis,
        m = rK(p.enabled, !f || !!f.isRadial || null, this.closestPointRangePx >= p.enabledThreshold * p.radius);
    ...
    markerAttribs(t, e) {
      ...
      e && (n = s.states[e], h = o.states && o.states[e], l = rK(h?.radius, n?.radius, l && l + (n?.radiusPlus || 0))), t.hasImage = r && 0 === r.indexOf("url"), t.hasImage && (l = 0);
      let d = t.pos();
      return rV(l) && d && (i.crisp && (d[0] = rB(d[0], t.hasImage ? 0 : "rect" === r ? s?.lineWidth || 0 : 1)), a.x = d[0] - l, a.y = d[1] - l), l && (a.width = a.height = 2 * l), a;
    }
    pointAttribs(t, e) {
      let i = this.options,
        s = i.marker,
      ...
      return c = a || h || n || c, p = r.fillColor || s.fillColor || c, g = r.lineColor || s.lineColor || c, e = e || "normal", l = s.states[e] || {}, u = rK((d = r.states && r.states[e] || {}).lineWidth, l.lineWidth, u + rK(d.lineWidthPlus, l.lineWidthPlus, 0)), p = d.fillColor || l.fillColor || p, g = d.lineColor || l.lineColor || g, {
        stroke: g,
        "stroke-width": u,
        fill: p,
    ...
    destroy(t) {
      ...
      V.clearTimeout(s.animationTimeout), rq(s, function (t, e) {
        t instanceof eJ && !t.survive && t[r && "group" === e ? "hide" : "destroy"]();
      }), o.hoverSeries === s && (o.hoverSeries = void 0), rW(o.series, s), o.orderItems("series"), rq(s, function (e, i) {
    ...
    plotGroup(t, e, i, s, o) {
      ...
      return rN(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (n.opacity = this.opacity), r || (this[t] = r = this.chart.renderer.g().add(o)), r.addClass("highcharts-" + e + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (rN(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0), r.attr(n)[a ? "attr" : "animate"](this.getPlotBox(e)), r;
    }
    getPlotBox(t) {
      let e = this.xAxis,
        i = this.yAxis,
    ...
    removeEvents(t) {
      ...
      t || rJ(this), e.length && (e.forEach(t => {
        t();
      }), e.length = 0);
    }
    render() {
    ...
    searchKDTree(t, e, i, s, o) {
      ...
      if (this.kdTree || this.buildingKdTree || this.buildKDTree(i), this.kdTree) return function t(e, i, s, o) {
        ...
        !function (t, e) {
          ...
          e.dist = Math.sqrt((o && o * o || 0) + l * l) - c, e.distX = rN(o) ? Math.abs(o) - c : Number.MAX_VALUE;
        }(e, l);
    ...
    pointPlacementToXValue() {
      let {
        ...
        i = t.pointPlacement;
      return "between" === i && (i = e.reversed ? -.5 : .5), rV(i) ? i * (t.pointRange || e.pointRange) : 0;
    }
    isPointInside(t) {
      let {
          chart: e,
    ...
    addPoint(t, e, i, s, o) {
      ...
      d.setRow(f, a, !0, {
        addColumns: !1
      }), p && f.name && (p[m] = f.name), g?.splice(a, 0, t), (r || this.processedData) && (this.data.splice(a, 0, null), this.processData()), "point" === n.legendType && this.generatePoints(), i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, g].filter(rN).forEach(t => {
        t.shift();
      }), d.deleteRows(0))), !1 !== o && rG(this, "addPoint", {
        point: f
    ...
    remove(t, e, i, s) {
      let o = this,
        r = o.chart;
      function a() {
        o.destroy(s), r.isDirtyLegend = r.isDirtyBox = !0, r.linkSeries(s), rK(t, !0) && r.redraw(e);
      }
    ...
    update(t, e) {
      ...
      g = g || r, u ? (p.push.apply(p, r0.keepPropsForPoints), !1 !== t.visible && p.push("area", "graph"), i.parallelArrays.forEach(function (t) {
        p.push(t + "Data");
      }), t.data && (t.dataSorting && rX(i.options.dataSorting, t.dataSorting), this.setData(t.data, !1))) : this.dataTable.modified = this.dataTable, t = r_(o, {
        index: void 0 === o.index ? i.index : o.index,
        pointStart: a?.series?.pointStart ?? o.pointStart ?? i.getColumn("x")[0]
      }, !u && {
        data: i.options.data
      }, t, h), u && t.data && (t.data = i.options.data), (p = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"].concat(p)).forEach(function (t) {
        p[t] = i[t], delete i[t];
      });
      let f = !1;
      if (rP[g]) {
        if (f = g !== i.type, i.remove(!1, !1, !1, !0), f) if (s.propFromSeries(), Object.setPrototypeOf) Object.setPrototypeOf(i, rP[g].prototype);else {
      ...
      if (p.forEach(function (t) {
        i[t] = p[t];
      }), i.init(s, t), u && this.points) for (let t of (!1 === (d = i.options).visible ? (l.graphic = 1, l.dataLabel = 1) : (this.hasMarkerChanged(d, o) && (l.graphic = 1), i.hasDataLabels?.() || (l.dataLabel = 1)), this.points)) t?.series && (t.resolveColor(), Object.keys(l).length && t.destroyElements(l), !1 === d.showInLegend && t.legendItem && s.legend.destroyItem(t));
      i.initialType = r, s.linkSeries(), s.setSortedData(), f && i.linkedSeries.length && (i.isDirtyData = !0), rG(this, "afterUpdate"), rK(e, !0) && s.redraw(!!u && void 0);
    }
    setName(t) {
    ...
    onMouseOver() {
      let t = this.chart,
        e = t.hoverSeries,
        i = t.pointer;
      i?.setHoverChartIndex(), e && e !== this && e.onMouseOut(), this.options.events.mouseOver && rG(this, "mouseOver"), this.setState("hover"), t.hoverSeries = this;
    }
    onMouseOut() {
      let t = this.options,
        e = this.chart,
        i = e.tooltip,
        s = e.hoverPoint;
      e.hoverSeries = null, s && s.onMouseOut(), this && t.events.mouseOut && rG(this, "mouseOut"), i && !this.stickyTracking && (!i.shared || this.noSharedTooltip) && i.hide(), e.series.forEach(function (t) {
        t.setState("", !0);
      });
    }
    setState(t, e) {
      ...
      if (t = t || "", i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function (e) {
        ...
        if (t && (h = a[t].lineWidth || h + (a[t].lineWidthPlus || 0), l = rK(a[t].opacity, l)), o && !o.dashstyle && rV(h)) for (let t of [o, ...this.zones.map(t => t.graph)]) t?.animate({
          "stroke-width": h
        }, n);
    ...
    setVisible(t, e) {
      ...
      ["group", "dataLabelsGroup", "markerGroup", "tracker", "tt"].forEach(t => {
        ...
        e.setVisible(t, !1);
      }), o && (s.isDirtyBox = !0), rG(i, a), !1 !== e && s.redraw();
    }
    show() {
      this.setVisible(!0);
    }
    ...
    select(t) {
      this.selected = t = this.options.selected = void 0 === t ? !this.selected : t, this.checkbox && (this.checkbox.checked = t), rG(this, t ? "select" : "unselect");
    }
  ...
  class ag {
    constructor(t, e) {
      this.allItems = [], this.initialItemY = 0, this.itemHeight = 0, this.itemMarginBottom = 0, this.itemMarginTop = 0, this.itemX = 0, this.itemY = 0, this.lastItemY = 0, this.lastLineHeight = 0, this.legendHeight = 0, this.legendWidth = 0, this.maxItemWidth = 0, this.maxLegendWidth = 0, this.offsetWidth = 0, this.padding = 0, this.pages = [], this.symbolHeight = 0, this.symbolWidth = 0, this.titleHeight = 0, this.totalItemWidth = 0, this.widthOption = 0, this.chart = t, this.setOptions(e), e.enabled && (this.render(), r5(this, e), r7(this.chart, "endResize", function () {
    ...
    update(t, e) {
      let i = this.chart;
      this.setOptions(an(!0, this.options, t)), "events" in this.options && r5(this, this.options), this.destroy(), i.isDirtyLegend = i.isDirtyBox = !0, ah(e, !0) && i.redraw(), ar(this, "afterUpdate", {
        redraw: e
      });
    }
    colorizeItem(t, e) {
      ...
      if ((t instanceof r1 || t instanceof oK) && (t.color = t.options?.legendSymbolColor || i), o?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
        let {
            itemHiddenStyle: i = {}
          } = this,
          o = i.color,
        ...
        r?.css(an(e ? this.itemStyle : i)), a?.attr(p({
          stroke: d || t.color
      ...
      t.color = i, ar(this, "afterColorizeItem", {
        item: t,
        visible: e
      });
    }
    ...
    positionCheckboxes() {
      ...
      e && (t = e.translateY, this.allItems.forEach(function (o) {
        let r,
          a = o.checkbox;
        a && (r = t + s + a.y + (this.scrollOffset || 0) + 3, ae(a, {
    ...
    renderItem(t) {
      ...
      !y && (e.group = s.g("legend-item").addClass("highcharts-" + g.type + "-series highcharts-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + t.index : "")).attr({
        zIndex: 1
      }).add(this.scrollGroup), e.label = y = s.text("", c ? a + n : -n, this.baseline || 0, m), i.styledMode || y.css(an(t.visible ? h : l)), y.attr({
        align: c ? "left" : "right",
        zIndex: 2
      }).add(e.group), !this.baseline && (this.fontMetrics = s.fontMetrics(y), this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop, y.attr("y", this.baseline), this.symbolHeight = ah(o.symbolHeight, this.fontMetrics.f), o.squareSymbol && (this.symbolWidth = ah(o.symbolWidth, Math.max(this.symbolHeight, 16)), b = this.symbolWidth + n + d + 20 * !!f, c && y.attr("x", this.symbolWidth + n))), g.drawLegendSymbol(this, t), this.setItemEvents && this.setItemEvents(t, y, m)), f && !t.checkbox && this.createCheckboxForItem && this.createCheckboxForItem(t), this.colorizeItem(t, t.visible), (i.styledMode || !h.width) && y.css({
    ...
    proximatePositions() {
      ...
      for (let o of (this.allItems.forEach(function (t) {
        let o,
          ...
          n,
          h;
        t.yAxis && (t.xAxis.options.reversed && (a = !a), t.points && (o = ao(a ? t.points : t.points.slice(0).reverse(), function (t) {
          return aa(t.plotY);
      ...
      }, this), r4(i, e.plotHeight))) t = o.item.legendItem || {}, aa(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos);
    }
    render() {
      let t = this.chart,
        e = t.renderer,
        ...
        l,
        d = this.box;
      this.itemX = s, this.itemY = this.initialItemY, this.offsetWidth = 0, this.lastItemY = 0, this.widthOption = ad(i.width, t.spacingBox.width - s), l = t.spacingBox.width - 2 * s - i.x, ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) > -1 && (l /= 2), this.maxLegendWidth = this.widthOption || l, h || (this.group = h = e.g("legend").addClass(i.className || "").attr({
        zIndex: 7
      }).add(), this.contentGroup = e.g().attr({
        zIndex: 1
      }).add(h), this.scrollGroup = e.g().add(this.contentGroup)), this.renderTitle(), ac(o, (t, e) => (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)), i.reversed && o.reverse(), this.allItems = o, this.display = r = !!o.length, this.lastLineHeight = 0, this.maxItemWidth = 0, this.totalItemWidth = 0, this.itemHeight = 0, o.forEach(this.renderItem, this), o.forEach(this.layoutItem, this), a = (this.widthOption || this.offsetWidth) + s, n = this.lastItemY + this.lastLineHeight + this.titleHeight, n = this.handleOverflow(n) + s, d || (this.box = d = e.rect().addClass("highcharts-legend-box").attr({
        r: i.borderRadius
        ...
        width: a,
        height: n
      }, d.strokeWidth())), h[r ? "show" : "hide"](), t.styledMode && "none" === h.getStyle("display") && (a = n = 0), this.legendWidth = a, this.legendHeight = n, r && this.align(), this.proximate || this.positionItems(), ar(this, "afterRender");
    }
    align(t = this.chart.spacingBox) {
      let e = this.chart,
        i = this.options,
        s = t.y;
      /(lth|ct|rth)/.test(this.getAlignment()) && e.titleOffset[0] > 0 ? s += e.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && e.titleOffset[2] > 0 && (s -= e.titleOffset[2]), s !== t.y && (t = an(t, {
        y: s
      })), e.hasRendered || (this.group.placed = !1), this.group.align(an(i, {
    ...
    handleOverflow(t) {
      let e = this,
        ...
        u = function (t) {
          "number" == typeof t ? w.attr({
            height: t
          }) : w && (e.clipRect = w.destroy(), e.contentGroup.clip()), e.contentGroup.div && (e.contentGroup.div.style.clip = t ? "rect(" + n + "px,9999px," + (n + t) + "px,0)" : "auto");
        },
        f = function (t) {
        ...
        k = this.nav,
        w = this.clipRect;
      return "horizontal" !== o.layout || "middle" === o.verticalAlign || o.floating || (v /= 2), h && (v = Math.min(v, h)), p.length = 0, t && v > 0 && t > v && !1 !== l.enabled ? (this.clipHeight = m = Math.max(v - 20 - this.titleHeight - n, 0), this.currentPage = ah(this.currentPage, 1), this.fullHeight = t, g.forEach((t, e) => {
      ...
      }), w || (w = e.clipRect = s.clipRect(0, n - 2, 9999, 0), e.contentGroup.clip(w)), u(m), k || (this.nav = k = s.g().attr({
        zIndex: 1
        ...
        e.scroll(1, d);
      })), e.scroll(0), t = v) : k && (u(), this.nav = k.destroy(), this.scrollGroup.attr({
        translateY: 1
      }), this.clipHeight = 0), t;
    }
    scroll(t, e) {
      ...
      l > o && (l = o), l > 0 && (void 0 !== e && r3(e, i), this.nav.attr({
        translateX: h,
      ...
      }), this.currentPage = l, this.positionCheckboxes(), ap(() => {
        ar(this, "afterScroll", {
          currentPage: l
        });
    ...
    setItemEvents(t, e, i) {
      ...
      for (let i of d) i && i.on("mouseover", function () {
        ...
        s.chart.styledMode || e.css(an(t.visible ? s.itemStyle : s.itemHiddenStyle)), c(""), r.removeClass(h), t.setState();
      }).on("click", function (e) {
        let i = function () {
          t.setVisible && t.setVisible(), c(t.visible ? "inactive" : "");
        };
        r.removeClass(h), ar(s, "itemClick", {
          browserEvent: e,
          legendItem: t
    ...
    createCheckboxForItem(t) {
      ...
      }, this.options.itemCheckboxStyle, this.chart.container), r7(t.checkbox, "click", function (e) {
        let i = e.target;
  ...
  class a0 {
    ...
    init(t, e) {
      aW(this, "init", {
        ...
        this.userOptions = az({}, t), (this.renderTo = aY(o) ? aw.getElementById(o) : o) || aN(13, !0, this), this.margin = [], this.spacing = [], this.labelCollectors = [], this.callback = e, this.isResizing = 0, this.options = i, this.axes = [], this.series = [], this.locale = i.lang.locale ?? this.renderTo.closest("[lang]")?.lang, this.time = new tu(az(i.time || {}, {
          locale: this.locale
        }), i.lang), i.time = this.time.options, this.numberFormatter = (s.numberFormatter || ab).bind(this), this.styledMode = s.styledMode, this.hasCartesianSeries = s.showAxes, this.index = ak.length, ak.push(this), w.chartCount++, av(this, s), this.xAxis = [], this.yAxis = [], this.pointCount = this.colorCounter = this.symbolCounter = 0, this.setZoomOptions(), aW(this, "afterInit"), this.firstRender();
      });
    }
    initSeries(t) {
    ...
    orderItems(t, e = 0) {
      ...
      if (this.hasRendered && (s.splice(e), o.splice(e)), i) for (let t = e, r = i.length; t < r; ++t) {
        let e = i[t];
        e && (e.index = t, e instanceof r1 && (e.name = e.getName()), e.options.isInternal || (s[t] = e.options, o[t] = e.userOptions));
      }
    }
    getClipBox(t, e) {
      let i = this.inverted,
      ...
      return t && (s && s.len !== this.plotSizeX && (n = s.len), o && o.len !== this.plotSizeY && (h = o.len), i && !t.invertible && ([n, h] = [h, n])), e && (r += (i ? o : s)?.pos ?? this.plotLeft, a += (i ? s : o)?.pos ?? this.plotTop), {
        x: r,
        y: a,
        width: n,
        height: h
    ...
    redraw(t) {
      ...
      let e = this.hasCartesianSeries ? this.axes : this.colorAxis || [],
        ...
        u;
      for (a.rootFontSize = a.boxWrapper.getStyle("font-size"), this.setResponsive && this.setResponsive(!1), ax(!!this.hasRendered && t, this), n && this.temporaryDisplay(), this.layOutTitles(!1), c = i.length; c--;) if (((u = i[c]).options.stacking || u.options.centerInCategory) && (d = !0, u.isDirty)) {
        l = !0;
        break;
      }
      if (l) for (c = i.length; c--;) (u = i[c]).options.stacking && (u.isDirty = !0);
      i.forEach(function (t) {
        t.isDirty && ("point" === t.options.legendType ? ("function" == typeof t.updateTotals && t.updateTotals(), g = !0) : r && (r.labelFormatter || r.labelFormat) && (g = !0)), t.isDirtyData && aW(t, "updatedData");
      ...
      }), p && this.drawChartBox(), aW(this, "predraw"), i.forEach(function (t) {
        (p || t.isDirty) && t.visible && t.redraw(), t.isDirtyData = !1;
      }), s && s.reset(!0), a.draw(), aW(this, "redraw"), aW(this, "render"), n && this.temporaryDisplay(!0), h.forEach(function (t) {
        t.call();
      });
    }
    get(t) {
    ...
    createAxes() {
      ...
      for (let e of (aW(this, "createAxes"), ["xAxis", "yAxis"])) for (let i of t[e] = aK(t[e] || {})) new s$(this, i, e);
    ...
    layOutTitles(t = !0) {
      ...
      this.titleOffset = e, aW(this, "afterLayOutTitles"), !this.isDirtyBox && r && (this.isDirtyBox = this.isDirtyLegend = r, this.hasRendered && t && this.isDirtyBox && this.redraw());
    }
    getContainerBox() {
    ...
    getChartSize() {
      ...
      this.chartWidth = Math.max(0, e || s.width || 600), this.chartHeight = Math.max(0, a_(i, this.chartWidth) || (o ? 400 : s.height)), this.containerBox = s;
    }
    temporaryDisplay(t) {
      let e = this.renderTo,
        i;
      if (t) for (; e?.style;) e.hcOrigStyle && (aO(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (aw.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode;else for (; e?.style && (aw.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, aw.body.appendChild(e)), ("none" === aX(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
        ...
        display: "block",
        overflow: "hidden"
      }, e !== this.renderTo && (i.height = 0), aO(e, i), e.offsetWidth || e.style.setProperty("display", "block", "important")), (e = e.parentNode) !== aw.body););
    }
    setClassName(t) {
    ...
    getContainer() {
      let t,
        ...
        r = this.renderTo,
        a = aZ(aP(r, s));
      aG(a) && ak[a] && ak[a].hasRendered && ak[a].destroy(), aP(r, s, this.index), r.innerHTML = t6.emptyHTML, i.skipClone || r.offsetWidth || this.temporaryDisplay(), this.getChartSize();
      ...
      if (this.renderer = new d(l, h, n, void 0, i.forExport, e.exporting?.allowHTML, this.styledMode), ax(void 0, this), this.setClassName(i.className), this.styledMode) for (let t in e.defs) this.renderer.definition(e.defs[t]);else this.renderer.setStyle(i.style);
    ...
    getMargins(t) {
      ...
      this.resetMargins(), s[0] && !aE(i[0]) && (this.plotTop = Math.max(this.plotTop, s[0] + e[0])), s[2] && !aE(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])), this.legend?.display && this.legend.adjustMargins(i, e), aW(this, "getMargins"), t || this.getAxisMargins();
    }
    getAxisMargins() {
      let t = this,
    ...
    setSize(t, e, i) {
      ...
      }), s.isDirtyLegend = !0, s.isDirtyBox = !0, s.layOutTitles(), s.getMargins(), s.redraw(r), s.oldChartHeight = void 0, aW(s, "resize"), setTimeout(() => {
        s && aW(s, "endResize");
      }, am(r).duration)), s.isResizing -= 1;
    }
    setChartSize(t) {
      let e,
        i,
      ...
      }), l.alignElements()), aW(this, "afterSetChartSize", {
        skipAxes: t
      });
    }
    resetMargins() {
    ...
    drawChartBox() {
      let t = this.options.chart,
        ...
        k,
        w = "animate";
      m || (this.chartBackground = m = e.rect().addClass("highcharts-background").add(), w = "attr"), o ? b = v = m.strokeWidth() : (v = (b = t.borderWidth || 0) + 8 * !!t.shadow, k = {
        fill: a || "none"
        ...
        fill: "none"
      }), y[w](y.crisp(g, -y.strokeWidth())), this.isDirtyBox = !1, aW(this, "afterDrawChartBox");
    }
    propFromSeries() {
      let t,
        e,
      ...
      ["inverted", "angular", "polar"].forEach(function (a) {
        for (e = aC[o.type], i = o[a] || e && e.prototype[a], t = r?.length; !i && t--;) (e = aC[r[t].type]) && e.prototype[a] && (i = !0);
        s[a] = i;
      });
    }
    linkSeries(t) {
      ...
      i.forEach(function (t) {
        ...
        if (aY(i)) {
          let s;
          (s = ":previous" === i ? e.series[t.index - 1] : e.get(i)) && s.linkedParent !== t && (s.linkedSeries.push(t), t.linkedParent = s, s.enabledDataSorting && t.setDataSortingOptions(), t.visible = aV(t.options.visible, s.options.visible, t.visible));
        }
    ...
    render() {
      let t = this.axes,
        ...
        n,
        h = 0;
      for (let e of (this.setTitle(), aW(this, "beforeMargins"), this.getStacks?.(), this.getMargins(!0), this.setChartSize(), t)) {
        let {
            options: t
          } = e,
          {
        ...
        if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
          ...
          let s = new sf(e, 0, "", !0),
            o = s.createLabel("x", i);
          if (s.destroy(), o && aV(i.reserveSpace, !aG(t.crossing)) && (r = o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)), r) {
            o?.destroy();
            break;
          }
        }
      ...
      this.drawChartBox(), this.hasCartesianSeries ? o(t) : e?.length && o(e), this.seriesGroup || (this.seriesGroup = i.g("series-group").attr({
        ...
        zIndex: 6
      }).add()), this.renderSeries(), this.addCredits(), this.setResponsive && this.setResponsive(), this.hasRendered = !0;
    }
    addCredits(t) {
      let e = this,
    ...
    destroy() {
      let t,
        ...
        o = e.container,
        r = o?.parentNode;
      for (aW(e, "destroy"), e.renderer.forExport ? aB(ak, e) : ak[e.index] = void 0, w.chartCount--, e.renderTo.removeAttribute("data-highcharts-chart"), aq(e), t = i.length; t--;) i[t] = i[t].destroy();
      ...
      ["title", "subtitle", "chartBackground", "plotBackground", "plotBGImage", "plotBorder", "seriesGroup", "clipRect", "credits", "pointer", "rangeSelector", "legend", "resetZoomButton", "tooltip", "renderer"].forEach(t => {
        e[t] = e[t]?.destroy?.();
      }), o && (o.innerHTML = t6.emptyHTML, aq(o), r && aD(o)), a$(e, function (t, i) {
        delete e[i];
      });
    }
    firstRender() {
      ...
      e.series = [], i.forEach(function (e) {
        t.initSeries(e);
      }), t.linkSeries(), t.setSortedData(), aW(t, "beforeRender"), t.render(), t.pointer?.getChartPosition(), t.renderer.imgCount || t.hasLoaded || t.onload(), t.temporaryDisplay(!0);
    }
    onload() {
      this.callbacks.concat([this.callback]).forEach(function (t) {
        t && void 0 !== this.index && t.apply(this, [this]);
      }, this), aW(this, "load"), aW(this, "render"), aE(this.index) && this.setReflow(), this.warnIfA11yModuleNotLoaded(), this.hasLoaded = !0;
    }
    ...
    addSeries(t, e, i) {
      let s,
        o = this;
      return t && (e = aV(e, !0), aW(o, "addSeries", {
        options: t
      }, function () {
        s = o.initSeries(t), o.isDirtyLegend = !0, o.linkSeries(), s.enabledDataSorting && s.setData(t.data, !1), aW(o, "afterAddSeries", {
          series: s
        }), e && o.redraw(i);
      })), s;
    }
    ...
    update(t, e, i, s) {
      ...
      aW(n, "update", {
        options: t
      }), l || n.setResponsive(!1, !0), t = aI(t, n.options), n.userOptions = aU(n.userOptions, t);
      let c = t.chart;
      c && (aU(!0, n.options.chart, c), this.setZoomOptions(), "className" in c && n.setClassName(c.className), ("inverted" in c || "polar" in c || "type" in c) && (n.propFromSeries(), o = !0), "alignTicks" in c && (o = !0), "events" in c && av(this, c), a$(c, function (t, e) {
        ...
        n[i] && "function" == typeof n[i].update ? n[i].update(e, !1) : "function" == typeof n[h[i]] ? n[h[i]](e) : "colors" !== i && -1 === n.collectionsWithUpdate.indexOf(i) && aU(!0, n.options[i], t[i]), "chart" !== i && -1 !== n.propsRequireUpdateSeries.indexOf(i) && (r = !0);
      }), this.collectionsWithUpdate.forEach(function (e) {
        t[e] && (aK(t[e]).forEach(function (t, s) {
          let o,
            r = aE(t.id);
          r && (o = n.get(t.id)), !o && n[e] && (o = n[e][aV(t.index, s)]) && (r && aE(o.options.id) || o.options.isInternal) && (o = void 0), o && o.coll === e && (o.update(t, !1), i && (o.touched = !0)), !o && i && n.collectionsWithInit[e] && (n.collectionsWithInit[e][0].apply(n, [t].concat(n.collectionsWithInit[e][1] || []).concat([!1])).touched = !0);
      ...
      a || aG(p) && p !== n.chartWidth || aG(g) && g !== n.chartHeight ? n.setSize(p, g, s) : aV(e, !0) && n.redraw(s), aW(n, "afterUpdate", {
        options: t,
        redraw: e,
        animation: s
      });
    ...
    pan(t, e) {
      let i = this,
        ...
        a = i.options.chart;
      a?.panning && (a.panning = s), aW(this, "pan", {
        originalEvent: t
      }, () => {
        i.transform({
          axes: r,
    ...
    transform(t) {
      ...
      for (let t of e) {
        ...
        (!t.isOrdinal || 1 !== k || o) && (P < Y && (P = Y, k >= 1 && (L = P + H)), L > U && (L = U, k >= 1 && (P = L - H)), (o || t.series.length && (P !== D || L !== B) && P >= Y && L <= U) && (r ? r[t.coll].push({
          ...
          min: P,
          max: L
        }) : (t.isPanning = "zoom" !== n, t.isPanning && (p = !0), t.setExtremes(o ? void 0 : P, o ? void 0 : L, !1, !1, {
          move: M,
          trigger: n,
          scale: k
        }), !o && (P > Y || L < U) && "mousewheel" !== n && (c = !0)), d = !0), this.hasCartesianSeries || o || "mousewheel" === n || (c = !0), i && (this[e ? "mouseDownX" : "mouseDownY"] = i[e ? "chartX" : "chartY"]));
      }
  ...
  function nt() {
    ...
    (this.scrollablePixelsX || this.scrollablePixelsY) && !t && (this.scrollablePlotArea = t = new ni(this)), t?.applyFixed();
  }
  function ne() {
  ...
  class ni {
    static compose(t, e, i) {
      a7(a2, this.compose) && (a3(t, "afterInit", ne), a3(e, "afterSetChartSize", t => this.afterSetSize(t.target, t)), a3(e, "render", nt), a3(i, "show", ne));
    }
    static afterSetSize(t, e) {
      ...
      if (!d.forExport) if (r ? (t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth), i && (t.scrollablePlotBox = a8(t.plotBox), h.width = t.plotWidth += i, n[l ? "height" : "width"] += i, o = !0)) : a && (t.scrollablePixelsY = s = Math.max(0, a - t.chartHeight), a9(s) && (t.scrollablePlotBox = a8(t.plotBox), h.height = t.plotHeight += s, n[l ? "width" : "height"] += s, o = !1)), a9(o)) {
    ...
    constructor(t) {
      ...
      this.mask = c.path().attr({
        ...
        zIndex: -1
      }).addClass("highcharts-scrollable-mask").add(), h.parentNode.insertBefore(d, h), a6(t.renderTo, {
        overflow: "visible"
      }), a3(t, "afterShowResetZoom", r), a3(t, "afterApplyDrilldown", r), a3(t, "afterLayOutTitles", r), a3(h, "scroll", () => {
        let {
          pointer: i,
          hoverPoint: s
        } = t;
    ...
    applyFixed() {
      let {
        ...
        m = r + p,
        x = a + g;
      e.setSize(r, a), (i ?? !0) && (this.isDirty = !1, this.moveFixedElements()), a1(t.container), a6(n, {
        width: `${m}px`,
        height: `${x}px`
      ...
      let y = d - o[0] - 1,
        ...
        M = d + h - g,
        S = [["M", 0, 0]];
      p ? S = [["M", 0, y], ["L", l - 1, y], ["L", l - 1, v], ["L", 0, v], ["Z"], ["M", w, y], ["L", r, y], ["L", r, v], ["L", w, v], ["Z"]] : g && (S = [["M", b, 0], ["L", b, d - 1], ["L", k, d - 1], ["L", k, 0], ["Z"], ["M", b, M], ["L", b, a], ["L", k, a], ["L", k, M], ["Z"]]), "adjustHeight" !== t.redrawTrigger && this.mask.attr({
        d: S
      });
    }
    moveFixedElements() {
    ...
    nd = class {
      ...
      setOffset(t, e, i, s, o, r) {
        ...
        if (h && p) {
          ...
          p.x -= o, p.y -= r, h.align(a, !1, p), (s = c.isInsidePlot(h.alignAttr.x + a.x + o, h.alignAttr.y + a.y + r)) || (i = !1), i && no.prototype.justifyDataLabel.call(n, h, a, h.alignAttr, t, p), h.attr({
            x: h.alignAttr.x,
            y: h.alignAttr.y,
            rotation: l.rotation,
            rotationOriginX: t.width * nn(l.textAlign || "center"),
            rotationOriginY: t.height / 2
          }), nl(!i && l.crop, !0) && (s = nh(h.x) && nh(h.y) && c.isInsidePlot(h.x - e + (h.width || 0), h.y) && c.isInsidePlot(h.x + e, h.y)), h[s ? "show" : "hide"]();
        }
  ...
  function nP(t, e) {
    ...
    for (k.stacksTouched += 1, h = 0; h < g; h++) {
      ...
      let S = o.total || 0;
      "percent" === l ? (r = s ? y : b, S = v && w[r]?.[e] ? (r = w[r][e]).total = Math.max(r.total || 0, S) + Math.abs(u) : nu(S + Math.abs(u))) : "group" === l ? ny(g) && S++ : S = nu(S + u), "group" === l ? o.cumulative = (S || 1) - 1 : o.cumulative = nu(nv(o.cumulative, m) + u), o.total = S, null !== g && (o.points[n].push(o.cumulative), p[h] = o.cumulative, o.hasValidPoints = !0);
    }
  ...
  class nL {
    ...
    cleanStacks() {
      this.oldStacks && (this.stacks = this.oldStacks, nb(this.stacks, t => {
        nb(t, t => {
    ...
    resetStacks() {
      nb(this.stacks, t => {
        nb(t, (e, i) => {
          ny(e.touched) && e.touched < this.stacksTouched ? (e.destroy(), delete t[i]) : (e.total = null, e.cumulative = null);
        });
      });
    }
    renderStackTotals() {
      ...
      r.translate(e.plotLeft, e.plotTop), nb(s, t => {
        nb(t, t => {
          t.render(r);
        });
      }), r.animate({
  ...
  (g || (g = {})).compose = function (t, e, i) {
    let s = e.prototype,
      o = i.prototype;
    s.getStacks || (ng(t, "init", nM), ng(t, "destroy", nw), s.getStacks = nk, o.getStackIndicator = nS, o.modifyStacks = nT, o.percentStacker = nC, o.setGroupedPoints = nA, o.setStackedPoints = nP);
  };
  let nO = g,
    {
      defined: nE,
  ...
  class nB extends r1 {
    drawGraph() {
      ...
      [this, ...this.zones].forEach((s, o) => {
        ...
        }, h ? r.dashstyle = h : "square" !== t.linecap && (r["stroke-linecap"] = r["stroke-linejoin"] = "round"), a[n](r).shadow(t.shadow && nI({
          filterUnits: "userSpaceOnUse"
        }, nD(t.shadow) ? t.shadow : {}))), a && (a.startX = e.xMap, a.isArea = e.isArea);
      });
    }
    getGraphPath(t, e, i) {
      let s = this,
      ...
      return l && t.reverse(), (h = {
        ...
        (l.leftCliff || u?.rightCliff) && !i && (n = !0), f && !nE(e) && d > 0 ? n = !o.connectNulls : f && !e ? n = !0 : (0 === d || n ? c = [["M", l.plotX, l.plotY]] : s.getPointSpline ? c = [s.getPointSpline(t, l, d)] : h ? (c = 1 === h ? [["L", u.plotX, g]] : 2 === h ? [["L", (u.plotX + p) / 2, u.plotY], ["L", (u.plotX + p) / 2, g]] : [["L", p, u.plotY]]).push(["L", p, g]) : c = [["L", p, g]], a.push(l.x), h && (a.push(l.x), 2 === h && a.push(l.x)), r.push.apply(r, c), n = !1);
      ...
      if (t = t || this.points, this.options.stacking) {
        ...
        s.forEach(function (t, g) {
          ...
          if (n[t] && !n[t].isNull) i.push(n[t]), [-1, 1].forEach(function (i) {
            ...
            u = nH(u, 0), u = r.translate(u, 0, 1, 0, 1), i.push({
              isNull: !0,
  ...
  class ht extends r1 {
    animate(t) {
      ...
      t && h ? (d.scaleY = .001, i = n0(o.toPixels(n.threshold || 0), r, r + o.len), l ? d.translateX = (i += a ? -Math.floor(h[0]) : Math.ceil(h[2])) - o.len : d.translateY = i += a ? Math.ceil(h[0]) : -Math.floor(h[2]), s.clipBox && s.setClip(), s.group.attr(d)) : (e = Number(s.group.attr(c)), s.group.animate({
        scaleY: 1
    ...
    crispCol(t, e, i, s) {
      ...
      return s = n1(e + s, o, r) - (e = n1(e, o, r)), this.options.crisp && (i = n1(t + i, o) - (t = n1(t, o))), {
        x: t,
        y: e,
        width: i,
        height: s
    ...
    translate() {
      ...
      i.pointPadding && i.crisp && (f = Math.ceil(f)), r1.prototype.translate.apply(t), t.points.forEach(function (s) {
    ...
    drawPoints(t = this.points) {
      ...
      t.forEach(function (t) {
        ...
        n9(h) && (null !== t.y || r) ? (e = t.shapeArgs, l && t.hasNewShapeType() && (l = l.destroy()), i.enabledDataSorting && (t.startXPos = i.xAxis.reversed ? -(e && e.width || 0) : i.xAxis.width), !l && (t.graphic = l = a[t.shapeType](e).add(t.group || i.group), l && i.enabledDataSorting && s.hasRendered && s.pointCount < n && (l.attr({
          x: t.startXPos
        }), d = !0, c = "animate")), l && d && l[c](n4(e)), s.styledMode || l[c](i.pointAttribs(t, t.selected && "select")).shadow(!1 !== t.allowShadow && o.shadow), l && (l.addClass(t.getClassName(), !0), l.attr({
          visibility: t.visible ? "inherit" : "hidden"
    ...
    drawTracker(t = this.points) {
      ...
      t.forEach(function (t) {
        e = n6(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : [], t.graphic && (t.graphic.element.point = t), e.forEach(function (e) {
      ...
      }), i._hasTracking = !0), n5(this, "afterDrawTracker");
    }
    remove() {
      let t = this,
        e = t.chart;
  ...
  !function (t) {
    ...
    function i(t, e, i, s, o) {
      ...
      if (g && u) {
        ...
        if (s = hr({
          ...
          width: 0,
          height: 0
        }, s || {}), "plotEdges" === i.alignTo && this.isCartesian && (s[n ? "x" : "y"] = 0, s[n ? "width" : "height"] = this.yAxis?.len || 0), hr(i, {
          width: h.width,
          height: h.height
        }), f = s, a && this.xAxis && !p && this.setDataLabelStartPos(t, e, o, c, f), e.align(hd(i, {
          width: l.width,
          height: l.height
        }), !1, s, !1), e.alignAttr.x += hn(i.align) * (l.width - h.width), e.alignAttr.y += hn(i.verticalAlign) * (l.height - h.height), e[e.placed ? "animate" : "attr"]({
        ...
        }), p && s.height >= 0) this.justifyDataLabel(e, i, e.alignAttr, h, s, o);else if (hp(i.crop, !0)) {
          let {
            x: t,
            y: i
          } = e.alignAttr;
    ...
    function r(t) {
      ...
      ha(this, "drawDataLabels"), i.hasDataLabels?.() && (e = this.initDataLabels(u), t.forEach(t => {
        let a = t.dataLabels || [],
          h = t.color || i.color;
        hu(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
          ...
          }) : v.css(f).shadow(n.shadow), ha(v, "beforeAddingDataLabel", {
            labelOptions: n,
            point: t
          }), v.added || v.add(e), i.alignDataLabel(t, v, n, void 0, k), v.isActive = !0, a[l] && a[l] !== v && a[l].destroy(), a[l] = v));
        });
        let l = a.length;
    ...
    function n(t, e) {
      let i = [],
        s;
      if (hh(t) && !hh(e)) i = t.map(function (t) {
        return hd(t, e);
      });else if (hh(e) && !hh(t)) i = e.map(function (e) {
        return hd(t, e);
      });else if (hh(t) || hh(e)) {
  ...
  !function (t) {
    function e(t, e, i, s, o) {
      ...
      i.align ?? (i.align = !n || p ? "center" : c ? "right" : "left"), i.verticalAlign ?? (i.verticalAlign = n || p ? "middle" : c ? "top" : "bottom"), hx.prototype.alignDataLabel.call(this, t, e, i, s, o), i.inside && t.contrastColor && e.css({
  ...
  !function (t) {
    t.getCenter = function () {
      ...
      for (!e.angular || this instanceof r1 || (g[3] = 0), c = 0; c < 4; ++c) p = g[c], h = c < 2 || 2 === c && /%$/.test(p), g[c] = hB(p, [s, o, a, g[2]][c]) + (h ? i : 0);
      return g[3] > g[2] && (g[3] = g[2]), hI(n) && 2 * n < g[2] && n > 0 && (g[3] = g[2] - 2 * n), hE(this, "afterGetCenter", {
        positions: g
      }), g;
  ...
  class hj extends oK {
    ...
    slice(t, e, i) {
      let s = this.series;
      hz(i, s.chart), e = hF(e, !0), this.sliced = this.options.sliced = t = hW(t) ? t : !this.sliced, s.options.data[s.data.indexOf(this)] = this.options, this.graphic && this.graphic.animate(this.getTranslate());
    }
  }
  hH(hj.prototype, {
    connectorShapes: {
      ...
      crookedLine: function (t, e, i) {
        ...
        let x = [["M", u, f]];
        return (g ? m <= u && m >= o.x : m >= u && m <= o.x) && x.push(["L", m, f]), x.push(["L", o.x, o.y], ["L", r.x, r.y]), x;
      }
    }
  });
  let {
    ...
    redrawPoints() {
      ...
      this.drawEmpty(), o.group && !r.styledMode && o.group.shadow(o.options.shadow), o.points.forEach(function (a) {
        ...
        e = a.graphic, !a.isNull && e ? (s = a.shapeArgs, t = a.getTranslate(), r.styledMode || (i = o.pointAttribs(a, a.selected && "select")), a.delayedRendering ? (e.setRadialReference(o.center).attr(s).attr(t), r.styledMode || e.attr(i).attr({
          "stroke-linejoin": "round"
        }), a.delayedRendering = !1) : (e.setRadialReference(o.center), r.styledMode || h_(!0, n, i), h_(!0, n, s, t), e.animate(n)), e.attr({
  ...
  !function (t) {
    ...
    function s() {
      ...
      }), h1.prototype.drawDataLabels.apply(t), e.forEach(t => {
        ...
        d && (t.sortByAngle(e, a - .5), m > 0 && (x = Math.max(0, l - h - m), y = Math.min(l + h + m, i.plotHeight), e.forEach(t => {
          ...
          (i.dataLabels || []).forEach(l => {
            let d = l.options || {},
              ...
              S = "inherit";
            if (x) {
              if (g && h5(m) && x.distance > 0 && (void 0 === m.pos ? S = "hidden" : (f = m.size, M = p.radialDistributionY(i, l))), d.justify) w = p.justify(i, l, h, n);else switch (d.alignTo) {
                case "connectors":
              ...
              if (x.attribs = {
                ...
                y: M + (d.y || 0) - v / 2
              }, x.computed.x = w, x.computed.y = M - k, h9(d.crop, !0)) {
                let t;
      ...
      }), (0 === h2(c) || this.verifyDataLabelOverflow(c)) && (this.placeDataLabels(), this.points.forEach(e => {
  ...
  !function (t) {
    ...
    function i(t, e) {
      ...
      let n = s?.ruleIds;
      o !== n && (s && (this.currentResponsive = void 0, this.updatingResponsive = !0, this.update(s.undoOptions, t, !0), this.updatingResponsive = !1), o ? ((r = lT(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0, this.currentResponsive = {
        ruleIds: o,
        mergedOptions: a,
        undoOptions: r
